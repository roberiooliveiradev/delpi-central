...
| `plugins/helpdesk` | (ver manifesto) | iframe legado | — | — | Alvo **Meus Chamados de TI** em [helpdesk/README.md](../12-roadmap-e-evolucao/helpdesk/README.md); ainda não implementado |
