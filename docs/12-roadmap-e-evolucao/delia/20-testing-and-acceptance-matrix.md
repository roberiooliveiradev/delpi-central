...
> **Not claimed:** runtime PASS/FAIL; C0.S6 APPROVED; C0.S7_AUTHORIZED; FOUNDATION_FREEZE; harness code/runtime.
> **Execution status for new behavioral tests:** `TEST_NOT_RUN`.
