...
C0.S0–C0.S7 estão aceitos (`FOUNDATION_FREEZE_REVIEW`, `APPROVE_WITH_NON_BLOCKING_RESIDUALS`). Autoriza C1; não inicia C1; não cria runtime DÉLIA; não prova production readiness.
