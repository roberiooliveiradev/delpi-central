...
C0.S0–C0.S6 estão aceitos (`ARCHITECTURE_REVIEW_C0_S6`, `ACCEPT_WITH_RESIDUAL`). Autoriza C0.S7; não executa FOUNDATION_FREEZE; não autoriza C1; não cria runtimes temáticos.
