...
## 22. C3-T1 Architecture Review linkage — accepted
...
NOTE_SUPERSEDED_BY: `ARCHITECTURE_REVIEW_C3_T4R1` (§27). Preserve as historical candidate/rework record.
...
CP-093 = PLANNED / PARTIAL (unchanged; EvidenceRef on result/lineage only)
CP-094 = PLANNED / PARTIAL (unchanged; OBSERVATION ≠ FACT enforced in SU)
CP-304 = LOCKED / LINEAGE FOUNDATION ACCEPTED (unchanged; lineage reused)
NEW_CP_CREATED = NO
RUNTIME_CP_PROMOTED_TO_PASS = NO
PRODUCTION_READINESS = NOT_PROVEN
...
## 27. C3-T4R1 Architecture Review linkage — accepted

Evidence anchors: `21` §4D; `17` C3-T4 block; `20` Gate C3-T4; ledger §6.72.
Review: `ARCHITECTURE_REVIEW_C3_T4R1`; `IMPLEMENTATION_HEAD=89bb5ad352b134ac6f8558c829a7f8720bc920d6`; `EVALUATED_SHA_BIND=07916cc459bcfd457bd9596c1f9646b7bc905ad9`; `CANDIDATE_BIND_HEAD=75d12fbb89a8ddc6815eaba86343a0fe11e4cd2b`; `REVIEW_REANCHOR_HEAD=0afc3154a7babb4617a019681930a81c80d39244`; verdict `ACCEPT_WITH_RESIDUAL`.
...
## 29. C3-T6 Expertise / Knowledge Governance + Retrieval Contracts — historical candidate

NOTE_SUPERSEDED_BY: §30 C3-T6R1

```text
C3_T6 = HISTORICAL_CANDIDATE
IMPLEMENTATION_HEAD = 537cf476646964f0866484c009043c261cf8f725
```

## 30. C3-T6R1 Knowledge Contract Rework — historical candidate

NOTE_SUPERSEDED_BY: §31 ARCHITECTURE_REVIEW_C3_T6R1

```text
C3_T6R1 = HISTORICAL_CANDIDATE
IMPLEMENTATION_HEAD = 1a49e501fb8e2d900081572de83d2226cc09fb68
```

## 31. C3-T6R2 Architecture Review linkage — accepted

Evidence anchors: `16` C3-T6R1 APPROVED; `20` C3-T6R1 evidence; ledger §6.76.
Review: `ARCHITECTURE_REVIEW_C3_T6R1`; `REVIEWED_IMPLEMENTATION_HEAD=1a49e501fb8e2d900081572de83d2226cc09fb68`; `REVIEW_REANCHOR_HEAD=446d93564a2219430c8afac3b283881f41c4d9ae`; `PRIOR_C3_T6_IMPLEMENTATION_HEAD=537cf476646964f0866484c009043c261cf8f725`; verdict `ACCEPT_WITH_RESIDUAL`.
