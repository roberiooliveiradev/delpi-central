...
NOTE_SUPERSEDED_BY = C3-T6R1 / ARCHITECTURE_REVIEW_C3_T6R1
```
...
EXPERTISE = ExpertisePack (evidence_refs: tuple[EvidenceRef, ...]; != authorization)
...
PHYSICAL_STORE = TO_INVENTORY / DEFERRED
NEW_RUNTIME_ABSTRACTIONS = NONE
RAG = NONE
VECTOR_STORE = NONE
REGISTRY = NONE
