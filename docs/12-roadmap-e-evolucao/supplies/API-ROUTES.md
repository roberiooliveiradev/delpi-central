...
| Entregas | GET | `/deliveries/late` | `supplies.access` + filtro de dados `01`/`02` | api-delpi `GET /supplies/purchase-order-otd/panel`; BFF+MFE no código; [P0 freeze](./evidence/e9-wf07-p0-contract-freeze.md); [gate](./evidence/e9-wf07-federated-runtime-gate.md) | **GATE FAIL** — MFE prod OK; BFF prod 404 |
