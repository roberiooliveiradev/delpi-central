...
export const PP_HELP = {
  ...
  otaLinks: {
    hero: "Hub OTA: amarre cada IoT a um firmware, dispare atualização e acompanhe o progresso. Sem vínculo, a OTA não encontra o device pela família.",
    ...
    canvas: "Arraste do firmware (esquerda) para o IoT, ou use Vincular no menu. Seta sólida = vínculo OTA.",
    connect: "Cria ou substitui o vínculo OTA explícito (1 IoT = 1 firmware).",
    disconnect: "Use Desvincular no nó IoT ou Backspace/Delete na seta sólida.",
    inherited: "Compatibilidade de driver aparece só no modo vínculo — não há linha tracejada permanente.",
    ...
    legend: "Sólida = vínculo OTA · sem linha = sem vínculo · compatibilidade só no modo Vincular.",
