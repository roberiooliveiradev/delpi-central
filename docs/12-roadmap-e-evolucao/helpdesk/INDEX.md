...
Conversa do chamado (inventário, sem autorização de código): [`10-conversa-do-chamado.md`](./10-conversa-do-chamado.md).
...
Nada nesta pasta, exceto o ledger, prova que a `helpdesk-api` ou o MFE nativo existem.
