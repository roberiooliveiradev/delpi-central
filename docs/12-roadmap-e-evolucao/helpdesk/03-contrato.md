...
`status` na lista e no detalhe é o **rótulo** do GLPI. O id numérico (1, 2, 3, 4, 5, 6, 10) e o ciclo ITIL estão só em [`14-pagina-e-estados-do-chamado.md`](./14-pagina-e-estados-do-chamado.md) e **não** estão autorizados.
