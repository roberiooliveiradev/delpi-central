...
Estado atual, decisões consolidadas, pendências e plano de evolução.
...
| Arquivo | Conteúdo |
|---|---|
| [status-atual.md](./status-atual.md) | Snapshot da plataforma |
...
| Arquivo | Conteúdo |
|---|---|
| [minha-delpi-chat/status-atual.md](./minha-delpi-chat/status-atual.md) | Chat plugin |
...
| Arquivo | Conteúdo |
|---|---|
| [eficiencia-fabril/README.md](./eficiencia-fabril/README.md) | Índice do módulo |
| [eficiencia-fabril/ESPECIFICACAO-PLUGIN.md](./eficiencia-fabril/ESPECIFICACAO-PLUGIN.md) | Funcionalidades implementadas (MVP) |
