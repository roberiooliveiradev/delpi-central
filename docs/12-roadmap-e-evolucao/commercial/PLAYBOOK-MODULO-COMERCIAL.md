...
| 1 | Informações fragmentadas; página central (faturado, carteira, gap, ofertas, atenção, atrasos) | **Parcial** | § 1.1 pilares; KPI-\*; MOD-\*; [WIREFRAMES](./WIREFRAMES.md) WF-01 | F0 + cockpit + F2b | Home + Overview **existem** (ROL, snapshot carteira, gap/horizon, atrasos); residual: ticket, amostras, FNE, soma ROL+carteira |
| 2 | Acompanhamento gerencial (ROL, carteira, ROL+carteira, MTD/YTD, ticket, amostras, pedidos…) | **Parcial** | § 7.2; § 10 dicionário; dashboard-commercial | F0 → evolução cockpit | MTD/YTD + snapshot carteira **Existem**; residual: ticket, carteira futura, amostras, **soma** ROL+carteira |
...
| 4 | Carteira e projeções pouco claras; diferença carteira Comercial × PCP | **Parcial** | KPI-002, KPI-008–010; FCT-\* | P0/P1 + F6 forecast | Copy ≠ PCP + snapshot **Existem**; residual: postergações, FCT, soma ROL+carteira |
| 5 | Visão rápida do vendedor (Conta 360: faturamento, carteira, pedidos, ofertas, follow-up, forecast) | **Parcial** | CLI-\*; WF-03/04; accounts 360 ([API-ROUTES](./API-ROUTES.md)) | F2b paridade; F5+ 360 completo | Conta já tem hist/pedidos/opp/atividades; residual: forecast e SLA de oferta |
