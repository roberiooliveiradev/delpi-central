...
| Peça | Situação |
|------|----------|
| **transformometro-api** | API canônica — CRUD, dashboard, integração S2S, migrations **V001–V020** |
| **plugins/transformometro** | UI oficial — cadastro, dashboard (3 visões), filiais, backup JSON |
