...
| AuthZ multiunidade | Core é a autoridade de permissão. Desenho em [AUTHZ-FINAL-DESIGN.md](./AUTHZ-FINAL-DESIGN.md). Pacote da fase 1 em [CORE-APP-UNIT-SCOPE-PACKET.md](./CORE-APP-UNIT-SCOPE-PACKET.md). Migração não autorizada |
