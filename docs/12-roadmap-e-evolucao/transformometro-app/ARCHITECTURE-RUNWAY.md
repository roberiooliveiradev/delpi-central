...
| ADRs | [adr-portal-transforma-plus.md](../../../transformometro-api/docs/architecture/adr-portal-transforma-plus.md), [adr-ciclo-inteligencia-processo.md](../../../transformometro-api/docs/architecture/adr-ciclo-inteligencia-processo.md), [adr-process-documentation-vs-meeting-minute.md](../../../transformometro-api/docs/architecture/adr-process-documentation-vs-meeting-minute.md) | Texto das decisões já tomadas |
...
| AuthZ multiunidade | Fatia 1: access/manage com compatibilidade. Filial saiu da autorização. Códigos antigos permanecem. Assignment humano ainda bloqueia a fase 6 |
