...
| AuthZ multiunidade | Sem segregação por unidade. Desenho em [AUTHZ-FINAL-DESIGN.md](./AUTHZ-FINAL-DESIGN.md). Pacote de unit scope cancelado. Migração não autorizada |
