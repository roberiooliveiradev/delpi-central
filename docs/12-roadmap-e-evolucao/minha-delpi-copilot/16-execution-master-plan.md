...
**Escopo:** `portal`, `minha-delpi-ai-api`, `plugins/minha-delpi-chat`, Core API, APIs de domínio e MFEs  
...
7. Workspace Context transporta referências estruturadas e bounded state, nunca o estado React inteiro.
...
- **C0–C2** podem evoluir: contratos, Portal Actions, CopilotBridge e Workspace Context;
...
- atualizar [`18-app-onboarding-matrix.md`](./18-app-onboarding-matrix.md);
...
Positive/sibling/negative obrigatórios.
...
Executar pelo use case genérico existente; nunca por DOM automation.
...
Gerar relatório AI-ready por app usando fatos do repo/runtime, alimentando a matriz de onboarding.
...
Classificar apps nos níveis definidos em `18-app-onboarding-matrix.md`.
...
Visibilidade de capabilities disponíveis, bloqueadas, writes, workflows, evals e gaps por app.
...
Cohort pequeno, reads/navigation primeiro.

## C7.S2 — Métricas e incident review

Observar TCR, correction rate, safe execution, confirmation abandonment, errors, latency/cost.

## C7.S3 — Rollout por waves

Expandir por apps, perfis e níveis de autonomia. Sem big-bang.

## C7.S4 — Aceite

Somente declarar Copilot production-ready quando [`14-definition-of-done.md`](./14-definition-of-done.md) e [`20-testing-and-acceptance-matrix.md`](./20-testing-and-acceptance-matrix.md) estiverem satisfeitos no HEAD final.
