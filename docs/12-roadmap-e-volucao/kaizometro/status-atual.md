...
2. Perfis sem permissão `kaizometro.*`
3. Ausência de scripts de homologação automatizada (`check-kaizometro.sh`)
...
| Migração UI `@delpi/plugin-ui` | `plugins/kaizometro/docs/UI-PLUGIN-UI.md` | F2/F3 concluído: filtros, KPI, forms, SectionCard, dashboard e detalhe |
