...
> **Arquivo:** `docs/12-roadmap-e-volucao/kaizometro/ESPECIFICACAO-REVISOES.md`  
> **Status:** proposta de design (não implementado)  
> **Relacionado:** [ROADMAP.md](./ROADMAP.md) · Fase 6 (summary Postgres) · [DOCUMENTACAO.md](../../../plugins/kaizometro/docs/DOCUMENTACAO.md)
...
| 5 | Permissão leitura revisões | Mesma de `kaizometro.view` |
