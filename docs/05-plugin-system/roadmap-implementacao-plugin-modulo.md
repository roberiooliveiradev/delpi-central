...
`dashboard-commercial`, `dashboard-production`, `dashboard-financial`, `dashboard-hr`, `dashboard-quality`, `dashboard-supplies`, `dashboard-engineering`, `dash-lmps`, `minha-delpi-chat`, `eficiencia-fabril`, `auditoria-5s`, `central-agendamento`, `kaizometro`, `inspecoes-entrada`, `pedidos-venda-abertos`, `propostas-comerciais`, `api-delpi-console`, `cultura-delpi`, `transformometro`, `helpdesk`, `idd_production`, etc.
