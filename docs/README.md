...
Última revisão estrutural: **set/2026**.
...
| [04-core-api/](./04-core-api/) | [README](./04-core-api/README.md) | Governança Core API |
| [05-plugin-system/](./05-plugin-system/) | [README](./05-plugin-system/README.md) | Manifestos · [plugin vs módulo](./05-plugin-system/plugin-vs-module.md) |
...
Não criar uma segunda pasta para roadmap/evolução. Todo novo roadmap deve ser colocado em `docs/12-roadmap-e-evolucao/`.

---

## Autoridade documental

A precedência arquitetural do repositório é definida por:

1. [instruções oficiais](./11-padroes-de-desenvolvimento/instrucoes-oficiais-gpt-arquiteto-delpi-central.md);
2. regras `.cursor` aplicáveis;
3. contratos/ADRs/OpenAPI/schemas e implementação vigente;
4. documentação técnica atual;
5. roadmap ativo.

`14-documentacao-geral` é material de referência. Quando divergir de fonte canônica atual, a fonte canônica prevalece e o documento de referência deve ser corrigido ou removido.
...
- **DELPI Central** — nome histórico ainda presente no repositório/client Keycloak onde o contrato técnico exigir.
