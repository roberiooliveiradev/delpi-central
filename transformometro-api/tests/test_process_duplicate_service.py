...
@patch("tm_app.application.services.process_duplicate_service.RevisaoEvidenceRepository")
@patch("tm_app.application.services.process_duplicate_service.RevisaoDecomposicaoOverlayRepository")
@patch("tm_app.application.services.process_duplicate_service.RevisaoDiagramOverlayRepository")
@patch("tm_app.application.services.process_duplicate_service.InstanciaDecomposicaoEscopoRepository")
...
@patch("tm_app.application.services.process_duplicate_service.MedicaoRepository")
@patch("tm_app.application.services.process_duplicate_service.RevisaoRepository")
