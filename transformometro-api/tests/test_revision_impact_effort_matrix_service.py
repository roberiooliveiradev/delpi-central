...
@patch("tm_app.application.services.revision_impact_effort_matrix_service.count_active_filiais", return_value=1)
@patch("tm_app.application.services.revision_impact_effort_matrix_service.DashboardDataRepository")
@patch("tm_app.application.services.revision_impact_effort_matrix_service.RevisaoRepository")
@patch("tm_app.application.services.revision_impact_effort_matrix_service.ProcessoInstanciaRepository")
...
@patch("tm_app.application.services.revision_impact_effort_matrix_service.RevisaoImpactEffortMatrixService.build_for_revisao")
@patch("tm_app.application.services.revision_impact_effort_matrix_service.RevisaoRepository")
def test_save_for_revisao_persists_and_returns_matrix(mock_repo, mock_build):
    ...
    assert persisted["format"] == "revision_impact_effort_matrix_v1"
...
def test_hibrido_modo_blends_manual_scores(mock_inst, mock_rev, mock_data, _mock_filiais):
    ...
    revisao_quick["matriz_impacto_esforco"] = {
        "format": "revision_impact_effort_matrix_v1",
        "format_version": 1,
        "modo": "hibrido",
...
@patch("tm_app.application.services.revision_impact_effort_matrix_service.RevisaoRepository")
@patch("tm_app.application.services.revision_impact_effort_matrix_service.ProcessoInstanciaRepository")
@patch("tm_app.application.services.revision_impact_effort_matrix_service.ProcessoRepository")
