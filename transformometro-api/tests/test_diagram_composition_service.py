...
@patch("tm_app.application.services.diagram_composition_service.RevisaoDiagramOverlayRepository")
@patch("tm_app.application.services.diagram_composition_service.InstanciaDiagramEscopoRepository")
@patch("tm_app.application.services.diagram_composition_service.RevisaoRepository")
@patch("tm_app.application.services.diagram_composition_service.ProcessoDiagramRepository")
