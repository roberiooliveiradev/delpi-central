...
from tm_app.infrastructure.persistence.repositories.process_setup_stats_repository import (
...
def test_enrich_processos_merges_setup_stats():
    ...
    with patch(
        "tm_app.application.services.process_setup_stats_service.ProcessoSetupStatsRepository"
    ) as repo_cls:
