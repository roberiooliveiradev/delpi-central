...
def test_create_rejects_setor_not_linked_to_filial(monkeypatch):
    ...
    monkeypatch.setattr(
        "tm_app.infrastructure.persistence.repositories.process_instance_repository.ProcessoRepository",
        lambda connection=None: processo_repo,
    )
    monkeypatch.setattr(
        "tm_app.infrastructure.persistence.repositories.process_instance_repository.SetorRepository",
