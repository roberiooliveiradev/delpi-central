-- Transformômetro — arquivos gerais do processo-mestre (metadado Postgres + binário em volume)
BEGIN;

CREATE TABLE IF NOT EXISTS transformometro.processo_arquivos (
...
CREATE INDEX IF NOT EXISTS idx_processo_arquivos_processo
    ON transformometro.processo_arquivos (processo_id)
