...
MATRIX_FORMAT = "revision_impact_effort_matrix_v1"
FORMAT_VERSION = 1
...
class MatrizImpactoEsforcoValidationError(ValueError):
    """Payload inválido para revision_impact_effort_matrix_v1."""
...
def validate_revision_impact_effort_matrix_v1(doc: Any) -> dict[str, Any]:
    data = _require_dict(doc, "matriz_impacto_esforco")
    if data.get("format") != MATRIX_FORMAT:
        raise MatrizImpactoEsforcoValidationError("format deve ser revision_impact_effort_matrix_v1.")
...
def build_persisted_matriz_payload(
    ...
    *,
    ...
    return validate_revision_impact_effort_matrix_v1(
        {
            "format": MATRIX_FORMAT,
            "format_version": FORMAT_VERSION,
            "modo": modo,
