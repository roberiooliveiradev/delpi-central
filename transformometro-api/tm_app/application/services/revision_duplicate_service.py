...
from tm_app.application.services.revision_tree_copy_service import copy_revisao_dependents
...
from tm_app.infrastructure.persistence.repositories.shared_resource_repository import VinculoRepository
