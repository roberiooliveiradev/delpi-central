...
>
> These playbooks stay guidance. They do not create SIPOC, Lean, Ishikawa, KPI or SWOT entities. Business outcomes and the target lifecycle are documented in [`CICLO-INTELIGENCIA-DE-PROCESSO.md`](../../../docs/12-roadmap-e-evolucao/transformometro-app/CICLO-INTELIGENCIA-DE-PROCESSO.md). The product experience name Portal Transforma+ does not add Actions per screen ([`PORTAL-TRANSFORMA-PLUS.md`](../../../docs/12-roadmap-e-evolucao/transformometro-app/PORTAL-TRANSFORMA-PLUS.md)). That document is not runtime.
>
