...
export const DM_HELP = {
  ...
  filiais: {
    ...
    status: "Ativo — filial disponível nos fluxos; inativo — oculta nas listagens operacionais.",
  },
  miniAplicadores: {
    ...
    ondeUsadoNivel: "Profundidade do item na estrutura (BOM) do produto.",
    ondeUsadoCodigo: "Código TOTVS do produto ou subconjunto na BOM.",
    ondeUsadoDescricao: "Descrição cadastral do item na estrutura.",
    ondeUsadoTipo: "Classificação do item na BOM (ex.: produto, componente).",
    ondeUsadoUnidade: "Unidade de medida utilizada na estrutura.",
    ondeUsadoQuantidade: "Quantidade necessária do componente no produto pai.",
    componentesNivel: "Nível hierárquico do componente na estrutura da ferramenta.",
    componentesCodigo: "Código TOTVS do componente amarrado à ferramenta.",
    componentesDescricao: "Descrição cadastral do componente.",
    componentesUnidade: "Unidade de medida do componente.",
    auditoria: "Histórico de alterações registradas no módulo.",
    auditoriaQuando: "Data e hora em que a alteração foi registrada.",
    auditoriaAcao: "Tipo de operação (inclusão, alteração ou exclusão).",
    auditoriaDetalhe: "Resumo dos dados envolvidos na operação.",
    auditoriaUsuario: "Usuário que executou a ação no módulo.",
  },
  relatorio: {
    ...
    colDataReposicao: "Data e hora em que a peça foi reposta na ferramenta.",
    colFerramenta: "Ferramenta (código e descrição) do par monitorado.",
    colPeca: "Peça (código e descrição) vinculada à ferramenta.",
    colGolpes: "Golpes registrados na reposição ou desde a última troca.",
    colStatusPreventiva: "Classificação preventiva conforme regras de Configuração.",
    colUltimaReposicao: "Data da reposição mais recente deste par ferramenta/peça.",
    colGolpesAtuais: "Golpes acumulados desde a última reposição.",
    colMediaGolpes: "Média histórica de golpes entre reposições desta peça.",
    colPercentualUso: "Percentual de uso atual em relação à média histórica.",
    colRevisaoStatus: "Situação da revisão programada (vencida, atenção ou OK).",
    colRevisaoFerramenta: "Ferramenta com revisão programada na filial.",
    colRevisaoProxima: "Data prevista para a próxima revisão programada.",
    colRevisaoDiasRestantes: "Dias até a próxima revisão (negativo indica atraso).",
  },
  configuracao: {
    motivoDescricao:
  ...
  programas: {
    ...
    rankingIntermediario: "Código e descrição do produto intermediário no ranking TOTVS.",
    rankingProdutoAcabado: "Produto acabado associado ao intermediário, quando informado.",
    rankingCtCorte: "Centro de trabalho de corte vinculado ao intermediário.",
    rankingOpAberta: "Indica se há ordem de produção em aberto para o intermediário.",
    rankingQtdProduzida: "Quantidade produzida no período considerado pelo ranking.",
    cadastroIntermediario: "Código do intermediário cadastrado para programas de máquina.",
    cadastroDescricao: "Descrição do intermediário no cadastro.",
    cadastroPa: "Produto acabado (PA) vinculado ao intermediário.",
    cadastroCt: "Centro de trabalho (CT) de corte configurado.",
    cadastroAtivacao: "Data em que o produto foi incluído no cadastro.",
    cadastroAtivadoPor: "Usuário que ativou o cadastro do produto.",
    cadastroAtivo: "Produto disponível ou desativado no cadastro de programas.",
  },
  manutencaoGeral: {
  ...
  revisao: {
    ...
    historicoIntervalo: "Periodicidade em meses vigente quando a revisão foi registrada.",
    historicoRegistradoEm: "Momento em que a revisão foi salva no histórico.",
  },
  preventivaDetalhe: {
