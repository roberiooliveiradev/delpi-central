...
export const MAINTENANCE_LIST_LAYOUT_KEYS = {
  ...
  ondeUsado: "maintenance:FerramentaOndeUsadoSection:layout:v1",
  motivos: "maintenance:ConfiguracaoPage:motivos:layout:v1",
  statusPreventivo: "maintenance:ConfiguracaoPage:status:layout:v1",
  programasRanking: "maintenance:ProgramasMaquinasPage:ranking:layout:v1",
  programasCadastro: "maintenance:ProgramasMaquinasPage:cadastro:layout:v1",
} as const;
