...
export const INTERACTION_ROOMS_CONTENT = {
  ...
  inboxRefreshingLabel: "Atualizando conversas…",
  ...
  renameRoomActionLabel: "Renomear conversa",
  renameRoomDialogTitle: "Renomear conversa",
  renameRoomFieldLabel: "Nome da conversa",
  renameRoomConfirmLabel: "Salvar",
  renameRoomCancelLabel: "Cancelar",
  renameRoomOk: "Conversa renomeada.",
  renameRoomError: "Não foi possível renomear a conversa.",
  renameRoomNameRequired: "Informe o nome da conversa.",
  ...
  sharedEmptyDescription: "Arquivos e links das mensagens aparecem aqui. Anexe pelo Chat.",
