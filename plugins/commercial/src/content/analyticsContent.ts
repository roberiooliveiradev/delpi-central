export const ANALYTICS_CONTENT = {
  ...
  overview: {
    ...
    chartSeriesColorsLabel: "Séries",
    chartTypeLabel: "Tipo",
    chartOverlaysPanelTitle: "Opções do gráfico",
    chartOverlaysEmpty: "Opções",
    chartSeriesColorsPanelTitle: "Configurar séries",
    chartSeriesColorsEmpty: "Séries",
    chartSeriesColorsReset: "Restaurar todas",
    chartSeriesColorsResetSeries: "Restaurar padrão",
    chartSeriesColorsTriggerAria: "Configurar séries do gráfico",
