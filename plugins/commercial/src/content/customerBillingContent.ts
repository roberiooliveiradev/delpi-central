...
export const CUSTOMER_BILLING_CONTENT = {
  ...
  filterCustomerCenter: "Centro do cliente",
  filterCustomerCenterEmpty: "Todos os centros",
  colCustomerCenter: "Centro",
  ...
  colTotal: "Total R$",
  colValue: "Valor R$",
  colDomesticQty: "Interno qtd",
  colExportQty: "Externo qtd",
  colTotalQty: "Total qtd",
  colValueQty: "Quantidade",
  colUnit: "UM",
