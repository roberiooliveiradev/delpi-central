...
export const ADMINISTRATION_CONTENT = {
  ...
  slas: {
    ...
    createFormTitle: "Nova política de SLA",
    editFormTitle: "Editar política de SLA",
    closeForm: "Fechar",
    saveCreate: "Criar política",
    saveEdit: "Salvar",
    saving: "Salvando…",
    ...
    deactivateConfirmTitle: "Desativar política?",
    deactivateConfirmMessage:
      "A política «{name}» deixará de valer para novos prazos. Você pode reativá-la editando o campo Ativo.",
    deactivateSuccess: "Política desativada.",
    ...
    fieldCode: "Código",
    fieldName: "Nome",
    fieldAppliesTo: "Aplica-se a",
    fieldDurationHours: "Duração (horas)",
    fieldCalendarCode: "Calendário (opcional)",
    fieldActive: "Ativa",
    colCode: "Código",
    colName: "Nome",
    colAppliesTo: "Aplica-se",
    colDuration: "Horas",
    colCalendar: "Calendário",
    colActive: "Ativa",
    colActions: "Ações",
    edit: "Editar",
    activeYes: "Sim",
    activeNo: "Não",
    codeRequired: "Informe o código.",
    nameRequired: "Informe o nome.",
    hoursRequired: "Informe a duração em horas (número positivo).",
    appliesToTask: "Tarefa",
    appliesToSample: "Amostra",
    appliesToOrderConfirmation: "Confirmação de pedido",
    appliesToOfferStage: "Etapa de oferta",
  },
  metrics: {
    total: "Carteiras",
    active: "Ativas",
