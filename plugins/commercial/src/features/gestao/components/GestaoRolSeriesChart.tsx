...
import { getCommercialRolSeries } from "../../../api/gestaoApi";
import type { ChartGranularity, CommercialRolSeriesPoint, GestaoFilterParams } from "../../../types/gestao";
import { formatCurrency } from "../../../utils/format";

type RolSeriesChartProps = {
  filters: Pick<GestaoFilterParams, "start_date" | "end_date" | "customer_segment">;
  granularity?: ChartGranularity;
};

export function GestaoRolSeriesChart({
  filters,
  granularity = "month",
}: RolSeriesChartProps) {
