...
type GestaoEquipePageProps = {
  basePath: string;
};

export function GestaoEquipePage({ basePath }: GestaoEquipePageProps) {
  ...
  return (
    <section className="cm-page-stack">
      <header className="cm-page-header-row">
        <CommercialTitleWithHelp
          title={GESTAO_CONTENT.equipe.title}
          hint={GESTAO_CONTENT.equipe.subtitle}
        />
