...
describe("CustomerDetailPage e navegacao (fonte)", () => {
  ...
  it("abas do mockup e aliases de secao", async () => {
    ...
    assert.equal(customerDetailTabId("contatos"), "customer-tab-contatos");
    assert.equal(customerDetailPanelId("contatos"), "customer-panel-contatos");
    ...
    assert.match(sections, /Contatos/);
