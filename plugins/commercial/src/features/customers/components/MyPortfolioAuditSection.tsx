 ...
 * Um único SectionCard colapsável; se «Todas», o seletor fica no corpo do card.
 */
export function MyPortfolioAuditSection({
  ...
  const portfolioSelect = needsManualSelect ? (
  ...
  return (
    <div className="cm-customers-page__audit">
      <SellerPortfolioAuditTimeline
        ...
        subtitle={
          needsManualSelect
            ? PORTFOLIO_AUDIT_CONTENT.selectPortfolioHint
            : PORTFOLIO_AUDIT_CONTENT.subtitleMember
        }
        hint={CM_HELP.customers.portfolioAudit}
        leading={portfolioSelect}
        showTimeline={Boolean(auditPortfolioId)}
        collapsible
        defaultOpen={false}
      />
    </div>
