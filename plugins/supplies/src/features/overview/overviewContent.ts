...
export const OVERVIEW_CONTENT = {
  ...
  otdChartEmptyMessage: "Não há série OTD para este período e unidade.",
  otdChartError: "Não foi possível carregar a série OTD.",
  otdSeriesLabel: "OTD %",
  otdSeriesPriorLabel: "OTD % (ano ant.)",
  openOtdLabel: "Abrir OTD",
  chartGranularityLabel: "Granularidade",
  chartTypeLabel: "Tipo",
  ...
  chartSeriesColorsLabel: "Cores",
  chartSeriesColorsEmpty: "Padrão",
  chartSeriesColorsPanelTitle: "Cores das séries",
  chartSeriesColorsTriggerAria: "Escolher cores das séries",
  chartSeriesColorsReset: "Restaurar cores",
  ...
  goalPrefix: "Meta",
  natureScopeHint: "Natureza temporal do indicador neste card.",
  temporalLabels: {
    interval: "Intervalo",
    snapshot: "Snapshot",
    state: "Estado atual",
