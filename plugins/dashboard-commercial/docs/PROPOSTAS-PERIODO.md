...
| **Paginação** | Rodapé do card | 20 registros/página → `page` + `page_size` |
...
| `page_size` | int | Tamanho (1–200, default 50; UI usa 20) |
...
| `src/hooks/useServerTable.ts` | Estado de página e ordenação |
...
Commits de referência: `396d1fc2`, `5c3589d2`, `dd53d04f`.
