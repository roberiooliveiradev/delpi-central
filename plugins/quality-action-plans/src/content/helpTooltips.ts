export const PAC_HELP_TOOLTIPS = {
  ...
  rnc8d: {
    ...
    contact: "Nome da pessoa de contato no cliente (campo Atenção para na planilha 8D).",
    customerEmail: "E-mail do contato no cliente para envio do relatório 8D.",
    customerPhone: "Telefone do contato no cliente.",
    delpiContact: "Interlocutor DELPI responsável pelo atendimento (campo Contato na planilha 8D).",
    delpiContactArea: "Área DELPI do interlocutor principal: comercial, qualidade, PCP, etc.",
    delpiSalesRep: "Vendedor DELPI vinculado ao cliente, quando distinto do interlocutor principal.",
    delpiQualityContact: "Referência de qualidade DELPI no caso (ex.: analista PAC).",
    ...
    defectiveQty: "Quantidade numérica de peças com defeito identificado.",
    defectiveQtyUnit: "Unidade da quantidade defeituosa (ex.: UNIDADES, PC).",
    phone: "Telefone comercial DELPI (campo ao lado de Contato na planilha 8D).",
    clientBatch: "Lote informado pelo cliente na reclamação.",
    batchQty: "Quantidade numérica total do lote reclamado.",
    batchQtyUnit: "Unidade da quantidade do lote (ex.: UNIDADES, PC).",
    disposition: "Decisão sobre o material (devolver, segregar, retrabalhar, etc.).",
    rejectedQty: "Quantidade numérica efetivamente rejeitada.",
    rejectedQtyUnit: "Unidade da quantidade rejeitada (ex.: UNIDADES, PC).",
