...
export function HelpTooltip({
  ...
  const rootClass = [
    ...
    visible ? "lmps-help-tooltip--open" : "",
    className,
  ]
    .filter(Boolean)
    .join(" ");
  ...
  const bubbleClass = [
    "lmps-help-tooltip__bubble",
    "lmps-help-tooltip__bubble--fixed",
    bubblePosition?.placement === "top"
      ? "lmps-help-tooltip__bubble--placement-top"
      : "lmps-help-tooltip__bubble--placement-bottom",
    positioned ? "lmps-help-tooltip__bubble--ready" : "",
  ]
    .filter(Boolean)
    .join(" ");
