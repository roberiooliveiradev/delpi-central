...
export type FiltersBarHiddenField = "workCenter" | "op" | "product";
...
type FiltersBarProps = {
  ...
  loading?: boolean;
  /** Campos fixos no contexto (ex.: CT na página do CT). */
  hiddenFields?: FiltersBarHiddenField[];
