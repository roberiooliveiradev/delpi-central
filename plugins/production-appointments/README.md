...
- Filtros auto-aplicados; detalhe da OP em `/apps/production-appointments/{sc|es}/op/:op` (inclui listagem de OPs filhas da família); detalhe do CT em `/apps/production-appointments/{sc|es}/ct/:ct`
