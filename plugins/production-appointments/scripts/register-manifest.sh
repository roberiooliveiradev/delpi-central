...
MANIFEST="${MANIFEST:-$SCRIPT_DIR/../production-appointments.manifest.json}"
...
echo "[OK] Atribua production-appointments.access, .view.filial-sc, .view.filial-es e .view no RBAC."
