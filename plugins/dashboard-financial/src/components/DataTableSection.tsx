    ...
    <section className="ds-card ds-table-section" aria-busy={loading || refreshing}>
      <div className="ds-table-section__header">
        <h2 className="ds-section-title">
          ...
          {titleHint ? (
            <HelpTooltip
              ...
              className="ds-table-section__title-help"
            />
          ) : null}
        </h2>
        <div className="ds-table-section__meta-group">
          ...
          {headerActions ? (
            <div className="ds-table-section__actions ds-no-print">{headerActions}</div>
          ) : null}
        </div>
      </div>
      ...
      {showInitialLoading ? (
        ...
        <>
          <div className="ds-table-toolbar">
            ...
            {!hideSearch ? (
              <div className="ds-table-toolbar__search-group">
                ...
                {searchHint ? (
                  <HelpTooltip
                    ...
                    className="ds-table-search__help"
                  />
                ) : null}
              </div>
            ) : null}
            ...
            {toolbarExtra ? (
              <div className="ds-table-toolbar__extra">{toolbarExtra}</div>
            ) : null}
          </div>
