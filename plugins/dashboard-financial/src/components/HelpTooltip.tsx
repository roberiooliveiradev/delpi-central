...
export function HelpTooltip({
  ...
  const rootClass = [
    "ds-help-tooltip",
    wrap ? "ds-help-tooltip--wrap" : "",
    visible ? "ds-help-tooltip--open" : "",
    className,
  ]
    .filter(Boolean)
    .join(" ");
  ...
  const bubbleClass = [
    "ds-help-tooltip__bubble",
    "ds-help-tooltip__bubble--fixed",
    bubblePosition?.placement === "top"
      ? "ds-help-tooltip__bubble--placement-top"
      : "ds-help-tooltip__bubble--placement-bottom",
    positioned ? "ds-help-tooltip__bubble--ready" : "",
  ]
    .filter(Boolean)
    .join(" ");
    ...
    >
      {wrap ? (
        ...
        <button
          ref={triggerRef}
          type="button"
          className="ds-help-tooltip__trigger"
