...
MANIFEST="${MANIFEST:-$SCRIPT_DIR/../financeiro-centro-custo.manifest.json}"
...
echo "[OK] Atribua financeiro-centro-custo.access (e view/export conforme perfil) no RBAC."
