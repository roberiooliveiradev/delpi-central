...
MANIFEST="${MANIFEST:-$SCRIPT_DIR/../purchase-requests.manifest.json}"
...
echo "[OK] Atribua purchase-requests.access, .view-all, .admin, .export e .unit.filial-01|02 conforme perfil de homologação."
