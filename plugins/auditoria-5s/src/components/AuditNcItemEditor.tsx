...
export function AuditNcItemEditor({
  auditId,
  item,
  form,
  attachmentsByNcId,
  ...
  return (
    <div className="a5s-nc-item__body">
      <div className="a5s-nc-item__context">
      ...
      <div className="a5s-nc-item__fields a5s-nc-item__fields--pair">
        <AuditNativeTextField
        ...
        <AuditNativeSelectField
          ...
          onChange={(value) => onChange({ priority: value as NcFormState["priority"] })}
          onBlur={onBlurSave}
        />
      </div>
