  ...
  return (
    <section className="si-igd-hero">
      <div className="si-igd-hero__content">
        ...
        <p className="si-igd-hero__description">
          O IGD consolida a performance dos principais departamentos da empresa
          em uma nota única de 0 a 10, apresentada no painel estratégico.
        </p>
