...
| OTD (%) | `GET /production/on_time_delivery_pct` | TOTVS SC2010 (OP mãe `001`, PA prefixos 9026/8000/8001) |
| **OTD — painel** | `GET /production/otd` | Resumo e listagem de OPs PA mãe (`C2_SEQUEN = 001`, prefixos 9026/8000/8001) |
