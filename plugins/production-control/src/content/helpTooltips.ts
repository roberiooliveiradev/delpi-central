export const helpTooltips = {
  ...
  machineLoad:
    "Fila de operações alocadas (SH8) congelada por filial e período. A fila de todos os CTs é carregada de uma vez, então trocar de aba é imediato. O status «em produção» vem da HZA e se atualiza sozinho a cada 30 s, sem recarregar a fila. Use Atualizar para regenerar a programação a partir do TOTVS. O rastreio localiza o conjunto (C2_NUM) ou o produto (PA) em todos os CTs.",
  machineLoadLocate:
