...
MANIFEST="${MANIFEST:-$SCRIPT_DIR/../production-pulse.manifest.json}"
...
echo "[OK] Atribua production-pulse.access, devices.view/manage/command, operator e view.filial-01|02 (ou admin) no RBAC."
