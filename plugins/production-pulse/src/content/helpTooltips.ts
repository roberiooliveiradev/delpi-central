...
export const PP_HELP = {
  ...
  detail: {
    ...
    deactivate:
      "Desativa o device. Para polling; não apaga histórico.",
    delta:
  ...
  ota: {
    ...
    phase: {
      awaiting: "Aguardando consulta OTA",
  ...
  otaLinks: {
    ...
    canvas: "Arraste do firmware (esquerda) para o IoT, ou use Vincular no menu ⋯. Clique no nó para resumo.",
    connect: "Cria ou substitui o vínculo OTA explícito (1 IoT = 1 firmware).",
    disconnect:
      "Use Desvincular no menu ⋯ ou Backspace/Delete na seta sólida. Compatibilidade de driver não gera linha.",
    inherited:
      "Compatibilidade de driver aparece só no modo vínculo — não há linha tracejada permanente no mapa.",
    ...
    legend:
      "Linha sólida = vínculo OTA explícito. Sem linha = sem vínculo. Compatibilidade só no modo Vincular.",
  ...
  hub: {
    ...
    edgeModesHint:
      "A linha sólida representa um vínculo OTA explícito entre Firmware e IoT. Para verificar compatibilidade ou criar um vínculo, use Vincular no menu ⋯.",
    edgeNone: "sem linha = sem vínculo OTA",
    edgeDashed: "compatível / incompatível — só no modo vínculo",
    edgeSolid: "──── vínculo OTA",
    linkModeTitle: "Modo vínculo",
    linkModeFirmwareHint: "Selecione um IoT compatível com esta família de firmware.",
    linkModeDeviceHint: "Selecione uma família de firmware compatível com o driver deste IoT.",
    linkCompatible: "Compatível — disponível para vínculo",
    linkIncompatible: "Este IoT utiliza um driver incompatível com este firmware.",
    linkIncompatibleFirmware: "Este firmware não é compatível com o driver deste IoT.",
    linkAlreadyAssigned: "Já vinculado a esta família",
    linkReplaceTitle: "Reatribuir vínculo?",
    linkReplaceBody:
      "Este IoT já possui vínculo OTA com outra família. Continuar substitui o vínculo anterior.",
    linkReplaceConfirm: "Reatribuir",
    linkSuccess: "Vínculo criado",
    linkSuccessBody: "O IoT foi vinculado ao firmware selecionado.",
    startLinkFromFirmware: "Selecione um IoT compatível com esta família de firmware.",
    startLinkFromDevice: "Selecione uma família de firmware compatível com o driver deste IoT.",
    cancelLinkMode: "Cancela o modo vínculo e restaura o mapa.",
    softDeleteDevice: "Desativa o IoT: para operação e polling; o cadastro permanece (filtro Inativos).",
    softDeleteFirmware:
      "Arquiva a versão: sai de novos disparos OTA; histórico e jobs antigos permanecem.",
    softDeleteDeviceConfirmTitle: "Desativar IoT?",
    softDeleteDeviceConfirmBody:
      "O dispositivo deixa de ser operado e some do filtro «Todos» como ativo. Reative depois pelo menu ⋯.",
    softDeleteDeviceConfirmLabel: "Desativar IoT",
    softDeleteFirmwareConfirmTitle: "Arquivar versão?",
    softDeleteFirmwareConfirmBody:
      "A versão deixa de ser elegível para novos disparos OTA. Histórico e jobs antigos permanecem.",
    softDeleteFirmwareConfirmLabel: "Arquivar versão",
    softDeleteDriver: "Arquiva o tipo de driver: some do catálogo ativo; IoTs existentes continuam resolvendo.",
    softDeleteDriverConfirmTitle: "Arquivar tipo de driver?",
    softDeleteDriverConfirmBody:
      "O tipo de driver deixa de aparecer em novos cadastros e no select de firmware. IoTs e versões já vinculados permanecem.",
    ...
    permanentDeleteBlockerFirmwareHistory: "{count} campanha(s) OTA no histórico.",
    permanentDeleteBlockerFirmwareActive: "{count} target(s) OTA ativo(s).",
    ...
    menuDisableDevice: "Desativa o IoT (filtro Inativos). Não apaga o cadastro.",
    ...
    panelDevices: "Abre o catálogo de IoTs da filial em modal (KPI, filtros e lista).",
    devicesDialogTitle: "IoTs",
    devicesCatalogList:
      "Catálogo da filial: saúde da frota, filtros e dispositivos. Abra o detalhe a partir da linha.",
    panelFirmwares: "Abre o catálogo de firmwares em modal.",
    ...
    catalog: "Catálogo de firmwares no modal — busque por família, versão ou driver.",
    catalogSearch: "Busca por família, versão, driver ou nome exibido.",
    jobs: "Jobs OTA no modal. Abra os detalhes para ver IoT por IoT.",
  ...
  drivers: {
    ...
    archiveSuccess: "Tipo de driver arquivado.",
