...
MANIFEST="${MANIFEST:-$SCRIPT_DIR/../financial.manifest.json}"
...
echo "[OK] Atribua: financial.access, financial.delinquency.view, financial.cost-centers.view, financial.indicators.view, financial.export, financial.view.filial-01 e/ou .filial-02."
