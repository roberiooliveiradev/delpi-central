 ...
 */
export function FinPeriodFilterButton({
  startDate,
  endDate,
  defaultStartDate,
  defaultEndDate,
  ...
  return (
    <div
      ref={rootRef}
      className={`fin-period-filter${open ? " fin-period-filter--open" : ""}${
        hasCustom ? " fin-period-filter--active" : ""
      }`}
    >
      <button
        type="button"
        className="fin-period-filter__trigger"
      ...
      <AnchoredPanelPortal
        ...
        anchorRef={rootRef}
        panelRef={panelRef}
        className="fin-period-filter__panel"
        variant="bare"
        role="dialog"
      ...
      >
        <p className="fin-period-filter__title">{copy.periodFilter.title}</p>
        <div className="fin-period-filter__fields">
          <label className="fin-period-filter__field" htmlFor={startId}>
          ...
          <label className="fin-period-filter__field" htmlFor={endId}>
        ...
        {error ? (
          <p className="fin-period-filter__error" role="alert">
            {error}
          </p>
        ) : null}
        <div className="fin-period-filter__actions">
          <button type="button" className="fin-period-filter__btn fin-period-filter__btn--ghost" onClick={clear}>
            {copy.periodFilter.reset}
          </button>
          <button type="button" className="fin-period-filter__btn fin-period-filter__btn--primary" onClick={apply}>
