/**
 * Shared quick-period presets for portal filters.
 * Timezone: America/Sao_Paulo — calendar date in that zone.
 * Generic temporal contract only: no dashboard, process, or unit semantics.
 */
 ...
 * - today / this_week / this_month / this_year / last_12_months → through today
 * - this_quarter → full civil quarter (1st day of 1st month → last day of 3rd month)
 * - last_month → previous civil month
