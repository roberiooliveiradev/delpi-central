  ...
  return (
    <>
      ...
      <DiagramLayoutProvider layout="default">
        <div className="delpi-ui-bpmn-workspace">
          {enabled && !open ? (
            <div className="delpi-ui-bpmn-workspace__expand-row">
              <HelpTooltip
              ...
              >
                <button
                  type="button"
                  className={`${GHOST_BTN} delpi-ui-bpmn-workspace__expand-btn`}
                  onClick={enter}
                >
          ...
          {!open ? <div className="delpi-ui-bpmn-workspace__body">{children}</div> : null}
        </div>
      ...
      >
        <DiagramLayoutProvider layout="fill">
          <div className="delpi-ui-bpmn-workspace delpi-ui-bpmn-workspace--modal-body">{children}</div>
        </DiagramLayoutProvider>
      </ModalShell>
    </>
  );
