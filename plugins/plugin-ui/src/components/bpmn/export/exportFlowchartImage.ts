...
const HTML_LABEL_SELECTORS = [
  ".delpi-ui-bpmn-node__label",
  ".delpi-ui-bpmn-node__external-label",
  ".delpi-ui-bpmn-inline-edit__display",
  ".delpi-ui-bpmn-lane__label",
] as const;
...
function buildExportPalette(canvasRoot: HTMLElement, viewport: HTMLElement): ExportPalette {
  const labelSample =
    viewport.querySelector(".delpi-ui-bpmn-node__label") ??
    viewport.querySelector(".delpi-ui-bpmn-node__external-label") ??
    viewport.querySelector(".delpi-ui-bpmn-inline-edit__display") ??
    viewport.querySelector(".delpi-ui-bpmn-lane__label");
  ...
  const nodeSample = viewport.querySelector(".delpi-ui-bpmn-node");
  const edgeTextBg =
...
export async function exportReactFlowDiagramPng({
  ...
  const editorRoot = canvasRoot.closest(".delpi-ui-bpmn-editor");
  ...
  editorRoot?.classList.add("delpi-ui-bpmn-editor--exporting");
  ...
  try {
    ...
    restoreExportStyles();
    editorRoot?.classList.remove("delpi-ui-bpmn-editor--exporting");
  }
}
