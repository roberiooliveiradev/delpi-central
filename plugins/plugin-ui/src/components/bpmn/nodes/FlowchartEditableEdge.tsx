...
import type { FlowchartEdgeKind } from "../model/diagram";
import {
  adjustEdgeLabelPosition,
  computeEdgePathOffsets,
} from "../layout/diagramEdgeRouting";
...
function baseEdgeStyle(kind: FlowchartEdgeKind | undefined) {
  ...
  return {
    strokeWidth: 1.5,
    stroke: "var(--delpi-ui-bpmn-edge-color, #94a3b8)",
    fill: "none",
    ...kindStyle,
  };
}
    ...
    <>
      ...
      {svgLabel ? (
        <EdgeText
          ...
          className={
            showLabelEditor
              ? "delpi-ui-bpmn-edge-label__export-only"
              : "delpi-ui-bpmn-edge-label__svg"
          }
        />
      ) : null}
      {showLabelEditor ? (
        <EdgeLabelRenderer>
          <div
            className="delpi-ui-bpmn-edge-label delpi-ui-bpmn-edge-label--editor nodrag nopan"
            style={{
          ...
          >
            <DiagramInlineTextEdit
              ...
              className="delpi-ui-bpmn-edge-label__text"
              inputClassName="delpi-ui-bpmn-edge-label__input"
