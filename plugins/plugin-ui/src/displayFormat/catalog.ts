...
export const DISPLAY_FORMAT_PRESETS: readonly DisplayFormatPreset[] = [
  ...
  },
  {
    ...
    spec: { category: "date", presetId: "date-short-yy", pattern: "dd/mm/yy" },
  },
  {
    id: "date-month-year",
    category: "date",
  ...
  {
    id: "date-month-year-yy",
    category: "date",
    label: "Mês/ano curto",
    description: "MM/yy",
    spec: { category: "date", presetId: "date-month-year-yy", pattern: "mm/yy" },
  },
  {
    id: "date-month-year-dash",
    category: "date",
    label: "Mês-ano",
    description: "MM-yyyy",
    spec: { category: "date", presetId: "date-month-year-dash", pattern: "mm-yyyy" },
  },
  {
    id: "date-month-year-dash-yy",
    category: "date",
    label: "Mês-ano curto",
    description: "MM-yy",
    spec: { category: "date", presetId: "date-month-year-dash-yy", pattern: "mm-yy" },
  },
  {
    id: "date-year-month",
    category: "date",
    label: "Ano/mês",
    description: "yyyy/MM",
    spec: { category: "date", presetId: "date-year-month", pattern: "yyyy/mm" },
  },
  {
    id: "date-year-month-yy",
    category: "date",
    label: "Ano curto/mês",
    description: "yy/MM",
    spec: { category: "date", presetId: "date-year-month-yy", pattern: "yy/mm" },
  },
  {
    id: "date-month-abbrev-year",
    category: "date",
    label: "Mês abreviado/ano",
    description: "MMM/yyyy",
    spec: { category: "date", presetId: "date-month-abbrev-year", pattern: 'mmm"."/yyyy' },
  },
  {
    id: "date-month-abbrev-year-yy",
    category: "date",
    label: "Mês abreviado/ano curto",
    description: "MMM/yy",
    spec: { category: "date", presetId: "date-month-abbrev-year-yy", pattern: 'mmm"."/yy' },
  },
  {
    id: "date-month-full-year",
    category: "date",
    label: "Mês por extenso/ano",
    description: "MMMM/yyyy",
    spec: { category: "date", presetId: "date-month-full-year", pattern: "mmmm/yyyy" },
  },
  {
    id: "date-month-full-year-yy",
    category: "date",
    label: "Mês por extenso/ano curto",
    description: "MMMM/yy",
    spec: { category: "date", presetId: "date-month-full-year-yy", pattern: "mmmm/yy" },
  },
  {
    id: "date-month-abbrev-de-year",
    category: "date",
    label: "Mês abreviado de ano",
    description: "MMM 'de' yyyy",
    spec: { category: "date", presetId: "date-month-abbrev-de-year", pattern: 'mmm "de" yyyy' },
  },
  {
    id: "date-month-full-de-year",
    category: "date",
    label: "Mês de ano",
    description: "MMMM 'de' yyyy",
    spec: { category: "date", presetId: "date-month-full-de-year", pattern: 'mmmm "de" yyyy' },
  },
  {
    id: "date-day-mon-year",
    category: "date",
    label: "Dia mês ano",
    description: "dd MMM yyyy",
    spec: { category: "date", presetId: "date-day-mon-year", pattern: 'dd mmm"." yyyy' },
  },
  {
    id: "date-day-mon-year-yy",
    category: "date",
    label: "Dia mês ano curto",
    description: "dd MMM yy",
    spec: { category: "date", presetId: "date-day-mon-year-yy", pattern: 'dd mmm"." yy' },
  },
  {
    id: "date-day-full-long",
    category: "date",
    label: "Dia de mês de ano",
    description: "dd 'de' MMMM 'de' yyyy",
    spec: { category: "date", presetId: "date-day-full-long", pattern: 'dd "de" mmmm "de" yyyy' },
  },
  {
    id: "date-day-full-long-yy",
    category: "date",
    label: "Dia de mês de ano curto",
    description: "dd 'de' MMMM 'de' yy",
    spec: { category: "date", presetId: "date-day-full-long-yy", pattern: 'dd "de" mmmm "de" yy' },
  },
  {
    id: "date-long",
    category: "date",
  ...
  },
  {
    ...
    label: "Ano curto",
    description: "yy",
    spec: { category: "date", presetId: "date-year-yy", pattern: "yy" },
  },
  {
    id: "date-month-num",
    category: "date",
    label: "Mês (número)",
    description: "MM",
    spec: { category: "date", presetId: "date-month-num", pattern: "mm" },
  },
  {
    id: "date-month-abbrev",
    category: "date",
    label: "Mês abreviado",
    description: "MMM",
    spec: { category: "date", presetId: "date-month-abbrev", pattern: 'mmm"."' },
  },
  {
    id: "date-month-full",
    category: "date",
    ...
    description: "MMMM",
    spec: { category: "date", presetId: "date-month-full", pattern: "mmmm" },
  },
  {
    id: "date-auto",
    category: "date",
