...
| `dashboard-financial` | `HelpTooltip`, `FieldLabel` |
| `dashboard-hr` | `HelpTooltip`, `FieldLabel` |
| `dashboard-lmps` | `HelpTooltip`, `FieldLabel` |
| `dashboard-quality` | `HelpTooltip`, `FieldLabel` |
| `dashboard-supplies` | `HelpTooltip`, `FieldLabel` |
