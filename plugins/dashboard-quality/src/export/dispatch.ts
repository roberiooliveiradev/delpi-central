...
import type {QualityExportRequest} from "./types";

const DASHBOARD_SUBTITLE = "Minha DELPI · Dashboard Qualidade";

export function runQualityExport(request: QualityExportRequest): void {
  switch (request.kind) {
    case "table":
