...
export function ChartCard({
  ...
  return (
    <section
      className={["dq-card", "dq-chart-card", className].filter(Boolean).join(" ")}
      aria-labelledby={titleId}
      role="region"
    >
      <div className="dq-chart-card__header">
        <div className="dq-chart-card__heading">
          <h2 id={titleId} className="dq-chart-card__title">
            ...
            {titleHint ? (
              <HelpTooltip
                ...
                className="dq-chart-card__title-help"
              />
            ) : null}
          </h2>
          {hint ? (
        ...
        {headerActions ? (
          <div className="dq-chart-card__actions dq-no-print">{headerActions}</div>
        ) : null}
      </div>
      <div
