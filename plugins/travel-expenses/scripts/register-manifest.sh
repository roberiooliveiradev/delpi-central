...
MANIFEST="${MANIFEST:-$SCRIPT_DIR/../travel-expenses.manifest.json}"
...
echo "[OK] Atribua travel-expenses.view/write/manage + travel-expenses.unit.filial-01|02 (ou travel-expenses.admin) no RBAC."
