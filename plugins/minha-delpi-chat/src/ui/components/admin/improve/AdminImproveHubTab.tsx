...
const HITL_CARDS: Array<{
...
}> = [
  {
    ...
    description: "Notas, vereditos e sugestões sobre respostas do assistente.",
    nav: { section: "quality", subTab: "evaluations" },
  },
  {
    id: "learning-candidates",
    title: "Candidatos de aprendizagem",
    description: "Fila de candidatos para vocabulário, memória e regressão.",
    nav: { section: "knowledge", subTab: "learning", page: "candidates" },
  },
  {
    id: "metrics-feedback",
    title: "Feedback nas métricas",
    description: "Thumbs e sinais de feedback na observabilidade de Qualidade.",
