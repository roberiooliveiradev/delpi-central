...
export const ADMIN_NAV_CONTENT_INDEX: AdminNavContentEntry[] = [
  ...
  entry(
    ...
    learningPath("finetuning", "Dataset de treino"),
    "Dataset de treino e exportação",
    "dataset amostra curada exportar capturada aprovada rejeitada jsonl ollama",
  ),
  entry(
    "agents-specialization",
    { section: "agents", subTab: "specialization" },
    "Agentes · Especialização",
    "Catálogo de especialização e Studio",
    "builder domínio rag diretrizes ferramentas provider action studio",
  ...
  entry(
    "quality-metrics",
    { section: "quality", subTab: "metrics", page: "overview" },
    "Qualidade · Métricas",
  ...
  entry(
    "quality-intent",
    { section: "quality", subTab: "metrics", page: "intent" },
    "Qualidade · Métricas",
  ...
  entry(
    ...
    { section: "quality", subTab: "metrics", page: "interactivity" },
    "Qualidade · Métricas",
  ...
  entry(
    "quality-feedback",
    { section: "quality", subTab: "metrics", page: "feedback" },
    "Qualidade · Métricas",
    "Feedback do usuário",
  ...
  entry(
    ...
    { section: "quality", subTab: "metrics", page: "presentation" },
    "Qualidade · Métricas",
    "Apresentação rica",
  ...
  entry(
    "quality-sql",
    { section: "quality", subTab: "metrics", page: "sql" },
    "Qualidade · Métricas",
    "SQL avançado",
  ...
  entry(
    ...
    { section: "quality", subTab: "metrics", page: "memory" },
    "Qualidade · Métricas",
  ...
  entry(
    "quality-web",
    { section: "quality", subTab: "metrics", page: "web" },
    "Qualidade · Métricas",
  ...
  entry(
    "quality-drawing",
    { section: "quality", subTab: "metrics", page: "drawing" },
    "Qualidade · Métricas",
  ...
  entry(
    "quality-vision",
    { section: "quality", subTab: "metrics", page: "vision" },
    "Qualidade · Métricas",
    "Visão de documentos",
  ...
  entry(
    "quality-errors",
    { section: "quality", subTab: "metrics", page: "errors" },
    "Qualidade · Métricas",
  ...
  entry(
    "quality-unified",
    { section: "quality", subTab: "metrics", page: "quality" },
    "Qualidade · Métricas",
    "Visão unificada",
  ...
  entry(
    "quality-text",
    { section: "quality", subTab: "metrics", page: "text" },
    "Qualidade · Métricas",
  ...
  entry(
    "quality-operations",
    { section: "quality", subTab: "metrics", page: "operations" },
    "Qualidade · Métricas",
