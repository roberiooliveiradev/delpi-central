...
export const PERSON_DIRECTORY_LABELS = {
  ...
  accessSubtitle: "Permissões e capacidades do Portal Transforma+ nesta sessão.",
  accessSelfOnly: "A lista completa de permissões aparece no seu próprio perfil.",
  accessLoading: "Carregando acessos…",
  superadmin: "Superadmin",
  capabilityAccess: "Acesso ao Portal",
  capabilityManage: "Administração do Portal",
  permissionAccess: "Acessar Portal Transforma+",
  permissionManage: "Administrar Portal Transforma+",
  shortcutHome: "Início",
