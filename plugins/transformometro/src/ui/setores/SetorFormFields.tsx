...
import { DS_FILTERS_ROW_EXTENDED, DS_FILTER_BOX_WIDE, DS_FILTER_BOX_WIDE_MOD } from "../../components/filterChrome";
...
export function SetorFormFields({ form, options, onChange }: Props) {
  ...
  return (
    <div className={DS_FILTERS_ROW_EXTENDED}>
      ...
      <TmNativeTextField id="tm-setor-nome" label="Nome do departamento *" hint={TM_HELP_TOOLTIPS.setores.nome} className={DS_FILTER_BOX_WIDE_MOD} required value={form.nome_setor} onChange={(nome_setor) => set({ nome_setor })} />
      <SelectField
        id="tm-setor-status"
        label="Status *"
