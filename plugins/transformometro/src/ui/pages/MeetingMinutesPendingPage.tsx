...
import { buildAtaSignPath, TRANSFORMOMETRO_ROUTES } from "../../constants/routes";
import { pendingAtas, type AtaListItem } from "../../data/api/transformometroMeetingMinutesApi";

type Props = Pick<AppProps, "getAccessToken"> & { onNavigate: (path: string) => void };
export function MeetingMinutesPendingPage({ getAccessToken, onNavigate }: Props) {
