...
import { InstanceReadView } from "../../components/instance/InstanceReadView";
...
import { RevisionComparisonSection } from "../../components/process/RevisionComparisonSection";
...
export function InstanceDetailPage({
  ...
  const instanciaMain = (
    <div className="tm-processo-workspace__sections">
      <InstanceWorkspaceSectionPanel active={activeSection === "dados"} sectionId="dados">
        <EditableSectionCard
          ...
          editContent={
            <ProcessInstancesPanel
              ...
              options={options}
              processScope={processo ? processScopeFromEntity(processo) : null}
      ...
      <InstanceWorkspaceSectionPanel active={activeSection === "mapeamento"} sectionId="mapeamento">
        <EditableSectionCard
      ...
      <InstanceWorkspaceSectionPanel active={activeSection === "diagrama"} sectionId="diagrama">
        <EditableSectionCard
      ...
      <InstanceWorkspaceSectionPanel active={activeSection === "contexto"} sectionId="contexto">
        <EditableSectionCard
      ...
      <InstanceWorkspaceSectionPanel active={activeSection === "revisoes"} sectionId="revisoes">
        <section ref={revisoesSectionRef} id="tm-instancia-revisoes" className="tm-panel-stack">
          ...
          {comparativo.length > 0 ? (
            <RevisionComparisonSection items={comparativo} columns={comparativoColumns} />
          ) : null}

          <DataTableSection
            columnPreferencesKey="transformometro:InstanceDetailPage:revis-es:v1"
