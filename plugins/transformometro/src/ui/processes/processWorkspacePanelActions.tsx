...
export function ProcessWorkspacePanelActionsProvider({ children }: { children: ReactNode }) {
...
export function useProcessWorkspacePanelActionsRegistry() {
 ...
 */
export function useProcessWorkspacePanelActions(actions: ReactNode, enabled: boolean) {
  const setPanelActions = useContext(PanelActionsDispatchContext);
