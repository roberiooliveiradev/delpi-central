...
export function HelpTooltip({
  ...
  const rootClass = [
    "tm-help-tooltip",
    wrap ? "tm-help-tooltip--wrap" : "",
    visible ? "tm-help-tooltip--open" : "",
    className,
  ]
    .filter(Boolean)
    .join(" ");
  ...
  const bubbleClass = [
    "tm-help-tooltip__bubble",
    "tm-help-tooltip__bubble--fixed",
    bubblePosition?.placement === "top"
      ? "tm-help-tooltip__bubble--placement-top"
      : "tm-help-tooltip__bubble--placement-bottom",
    positioned ? "tm-help-tooltip__bubble--ready" : "",
  ]
    .filter(Boolean)
    .join(" ");
    ...
    >
      {wrap ? (
        ...
        <button
          ref={triggerRef}
          type="button"
          className="tm-help-tooltip__trigger"
