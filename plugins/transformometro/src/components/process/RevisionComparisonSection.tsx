...
export function RevisionComparisonSection({ items, columns }: Props) {
  ...
  return (
    <section className="tm-comparativo-section">
      ...
      >
        <DataTableSection
          columnPreferencesKey="transformometro:RevisionComparisonSection:revisaocomparativosection:v3"
          title=""
          columns={columns}
          rows={items}
