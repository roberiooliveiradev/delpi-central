...
export function DashboardEngineeringPage({ pathname }: DashboardEngineeringPageProps) {
  ...
  const kpiExportRows = useMemo(
    () => {
      ...
      const lmpOnTimeGoal = buildKpiGoalPresentationWithBranchIdd(
      ...
      const transformaSavingsGoal = buildKpiGoalPresentationWithBranchIdd(
        `${branchLabel} · ${periodLabel}`,
        transforma,
        {
      ...
      return [
        {
          ...
          contexto: joinKpiExportContext(
            `${branchLabel} · ${periodLabel}`,
            ...formatKpiGoalExportFragments(lmpOnTimeGoal),
          ),
        },
        {
        ...
        },
        {
          ...
          contexto: joinKpiExportContext(
            `${branchLabel} · ${periodLabel}`,
            ...formatKpiGoalExportFragments(transformaSavingsGoal),
          ),
        },
        {
