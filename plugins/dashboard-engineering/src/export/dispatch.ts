...
import type {EngineeringExportRequest} from "./types";

const DASHBOARD_SUBTITLE = "Minha DELPI · Dashboard Engenharia";

export function runEngineeringExport(request: EngineeringExportRequest): void {
  switch (request.kind) {
    case "table":
