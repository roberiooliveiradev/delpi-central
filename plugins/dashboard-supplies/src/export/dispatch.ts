...
import type {SuppliesExportRequest} from "./types";

const DASHBOARD_SUBTITLE = "Minha DELPI · Dashboard Suprimentos";

export function runSuppliesExport(request: SuppliesExportRequest): void {
  switch (request.kind) {
    case "table":
