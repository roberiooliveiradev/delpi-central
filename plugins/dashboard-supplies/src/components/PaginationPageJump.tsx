...
function resolveJumpErrorMessage(
  ...
  switch (reason) {
    case "empty":
      return SUPPLIES_HELP_TOOLTIPS.pagination.jumpEmpty;
    case "invalid":
      return SUPPLIES_HELP_TOOLTIPS.pagination.jumpInvalid;
    case "below_min":
      return SUPPLIES_HELP_TOOLTIPS.pagination.jumpBelowMin;
    case "above_max":
...
export function PaginationPageJump({
  ...
  return (
    <div className="ds-pagination__jump">
      ...
      <HelpTooltip
        content={SUPPLIES_HELP_TOOLTIPS.pagination.jump}
