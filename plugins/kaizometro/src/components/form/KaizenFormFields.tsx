  ...
  return (
    <>
      ...
      <FormSection
        ...
        description={`Escolha o tipo — só os parâmetros que se aplicam a ele aparecem. Economia/ano = ${ANNUAL_SAVINGS_FORMULA_LABEL} (constante Delpi); validade no painel = 1 ano corrido.`}
      >
