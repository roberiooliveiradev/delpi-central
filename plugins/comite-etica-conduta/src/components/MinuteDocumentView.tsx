...
import { getSignatureImage, type MinuteDetail } from "../api/cecApi";
import {
  PARTICIPANT_ROLE_LABELS,
  STATUS_LABELS,
  UNIT_LABELS,
} from "../constants/labels";
import logoComiteEtica from "../assets/Emblema-Comite-Etica-Conduta-Delpi-transparente.png";
...
/** Espelho de leitura do documento oficial; o PDF autoritativo continua no comite-etica-conduta-api. */
  ...
  return (
    <DocumentReader toolbar={toolbar} className={className} ariaLabel="Modo de leitura da ata">
      <DocumentPage
        header={
          <DocumentHeader
            logo={<img src={logoComiteEtica} alt="Comitê de Ética e Conduta" />}
            title="Comitê de Ética e Conduta"
            subtitle="Integridade, respeito e responsabilidade"
          />
        }
        watermark={<img src={logoComiteEtica} alt="" />}
        footer={
          <DocumentFooter
      ...
      >
        <div className="cec-minute-document">
          <h1>Ata de reunião do Comitê de Ética</h1>
          <p className="cec-minute-document__date">
          ...
          {["agenda_html", "body_html", "decisions_html", "pending_html", "observations_html"].map(
            (field) => {
              ...
              return (
                <div
                  key={field}
                  className="cec-minute-document__content delpi-ui-document-rich-content"
          ...
          <h2>Assinaturas:</h2>
          <div className="cec-minute-document__signatures">
          ...
          <div className="cec-minute-document__validation">
            <span>
