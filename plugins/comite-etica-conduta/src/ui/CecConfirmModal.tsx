...
const CONFIRM_CLASSES: ConfirmModalClassNames = {
  message: "comite-etica-conduta-confirm-modal__message",
  actions: "comite-etica-conduta-form-actions comite-etica-conduta-form-actions--end",
  cancelButton: "delpi-ui-action-btn delpi-ui-action-btn--ghost",
  confirmButton: "delpi-ui-action-btn delpi-ui-action-btn--primary",
  confirmButtonDanger: "delpi-ui-action-btn comite-etica-conduta-action-btn--danger",
};
...
export function CecConfirmModal({
  open,
  title,
  message,
