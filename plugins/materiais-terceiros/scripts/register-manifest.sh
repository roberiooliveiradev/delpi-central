...
MANIFEST="${MANIFEST:-$SCRIPT_DIR/../materiais-terceiros.manifest.json}"
...
echo "[OK] Atribua materiais-terceiros.access, .view.filial-sc, .view.filial-es e .export (conforme perfil) no RBAC."
