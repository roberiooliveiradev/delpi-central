...
/** Quebra o texto do comentário em segmentos de texto e menção (sem o @ na exibição). */
export function splitCommentMentionSegments(text: string): CommentMentionSegment[] {
  const source = text ?? "";
  if (!source) return [];
