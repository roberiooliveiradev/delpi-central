export const TV_DASHBOARD_HELP_TOOLTIPS = {
  ...
  contextMenu: {
    ...
    distributeH: "Distribuir na horizontal",
    distributeV: "Distribuir na vertical",
    alignSlideLeft: "Alinhar à esquerda do slide",
    alignSlideCenterH: "Centralizar no slide (H)",
    alignSlideRight: "Alinhar à direita do slide",
    alignSlideTop: "Alinhar ao topo do slide",
    alignSlideCenterV: "Centralizar no slide (V)",
    alignSlideBottom: "Alinhar à base do slide",
    rotate: "Girar",
