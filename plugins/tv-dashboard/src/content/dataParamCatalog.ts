...
export const PARAM_FIELD_LABELS: Record<string, string> = {
  ...
  "customer": "Cliente",
  "customer_centers": "Centros do cliente",
  "customer_code": "Código do cliente",
  "customer_code_stores": "Pares cliente|loja",
  "customer_codes": "Códigos de clientes",
  "customer_name": "Nome do cliente",
  "customer_names": "Nomes de clientes (incluir)",
  "customer_reference": "Referência do cliente",
  "customer_segment": "Segmento",
  "customer_stores": "Lojas do cliente",
  "customers": "Clientes",
  "data": "Data",
  "dataFim": "Data fim",
  ...
  "end_date": "Data fim",
  "entry_end": "Digitação — fim",
  "entry_start": "Digitação — início",
  "eventTypes": "Tipos de evento",
  "evidence_type": "Tipo de evidência",
  "excludeWeekends": "Ocultar fins de semana",
  "exclude_customer_codes": "Excluir códigos de clientes",
  "exclude_customer_names": "Excluir nomes de clientes",
  ...
  "format": "Formato",
  "freight_document": "Número do CT-e",
  "freight_mode": "Modalidade de transporte",
  "from": "De",
  ...
  "inspector": "Inspetor",
  "invoice_document": "Número da NF",
  "invoice_number": "Número da nota",
  "invoice_type": "Tipo de NF",
  "issue_date_end": "Data de emissão (fim)",
  "issue_date_start": "Data de emissão (início)",
  "issue_end": "Emissão — fim",
  "issue_start": "Emissão — início",
  "issued_from": "Emitida de",
  "issued_to": "Emitida até",
  ...
  "only_with_balance": "Somente com saldo",
  ...
  "order_number": "Número do pedido de compra",
  ...
  "partner_code": "Código do cliente",
  "partner_store": "Loja do cliente",
  "party_code": "Código do destinatário",
  "party_store": "Loja do destinatário",
  "party_type": "Tipo de destinatário",
  ...
  "product_codes": "Códigos de produtos",
  ...
  "receipt_number": "NF de recebimento",
  "recurso": "Recurso",
...
export const PARAM_FIELD_HINTS: Record<string, string> = {
  ...
  "customer_centers": "Lista CSV de centros do cliente na amarração produto–cliente (SA7.A7_XCENT), ex.: 1320,1505.",
  "customer_code": "Código do cliente (CLIENTE).",
  "customer_code_stores": "Lista CSV de pares código|loja TOTVS a incluir (ex.: 000001|01,000001|05).",
  "customer_codes": "Lista CSV de códigos TOTVS de clientes a incluir (filtro de carteira).",
  "customer_name": "Nome (ou parte do nome) do cliente.",
  "customer_names": "Lista CSV de nomes de clientes a incluir (correspondência parcial, LIKE).",
  ...
  "customer_stores": "Lista CSV de lojas TOTVS do cliente (A1_LOJA / D2_LOJA).",
  ...
  "dateRangePreset": "Atalho de período (este mês, este mês ano passado, mesmo período ano passado, últimos 30 dias etc.).",
  ...
  "entry_end": "Data de digitação da NF de compra, fim do período (AAAA-MM-DD).",
  "entry_start": "Data de digitação da NF de compra, início do período (AAAA-MM-DD).",
  ...
  "exclude_customer_codes": "Lista CSV de códigos TOTVS de clientes a excluir do resultado.",
  "exclude_customer_names": "Lista CSV de nomes de clientes a excluir (correspondência parcial, NOT LIKE).",
  "expected_revision_number": "Número de revisão para concorrência otimista.",
  "export_format": "Formato do arquivo: csv ou xlsx.",
  ...
  "freight_document": "Número do documento de frete (CT-e).",
  "freight_mode": "CIF ou FOB.",
  ...
  "include": "Flags CSV para blocos extras na resposta (ex.: portfolio para carteira semanal).",
  ...
  "invoice_document": "Número do documento da NF de compra.",
  "invoice_number": "Número da nota fiscal.",
  "invoice_type": "Tipo da nota: venda, devolução, amostra, remessa de conserto ou outros.",
  ...
  "issue_end": "Data de emissão da NF de compra, fim do período (AAAA-MM-DD).",
  "issue_start": "Data de emissão da NF de compra, início do período (AAAA-MM-DD).",
  "issued_from": "Data de emissão inicial (inclusiva, AAAA-MM-DD).",
  "issued_to": "Data de emissão final (inclusiva, AAAA-MM-DD).",
  ...
  "lot": "Número do lote.",
  "market": "Filtro de mercado: domestic (CFOP 5/6) ou export (CFOP 7).",
  ...
  "only_with_balance": "Quando verdadeiro, apenas remessas ainda pendentes.",
  ...
  "order_number": "Número do pedido de compra (SC7.C7_NUM).",
  ...
  "partner_code": "Código do cliente (SA1).",
  "partner_store": "Loja do cliente (SA1).",
  "party_code": "Código TOTVS do cliente ou fornecedor (SA1/SA2).",
  "party_store": "Loja TOTVS do cliente ou fornecedor.",
  "party_type": "Cliente (SA1) ou fornecedor (SA2).",
  "pending_only": "Retorna NCs em aberto: aguardando registro, plano em registro e aguardando evidências.",
  ...
  "product_codes": "Lista CSV de códigos de produto (SB1.B1_COD / D2_COD).",
  "product_group": "Grupo de produto no Protheus.",
  "product_groups": "Lista CSV de famílias/grupos de produto (SB1.B1_GRUPO).",
  ...
  "return_number": "Número da nota fiscal de retorno.",
  "revision": "Número ou código da revisão.",
  "root_cause_category": "Categoria da causa raiz.",
  "savings_type": "Tipo de economia (Kaizen).",
  "scheduled_end": "Fim da janela de operações programadas (H8_DTINI, AAAA-MM-DD).",
  "scheduled_start": "Início da janela de operações programadas (H8_DTINI, AAAA-MM-DD).",
  ...
  "shift": "Filtro de turno. 5S: TURNO_1|TURNO_2|TURNO_3|ADMINISTRATIVO; eficiência fabril: 1|2|3 (ou CSV).",
  ...
  "tool": "Ferramenta alocada na operação (H8_FERRAM). MOD indica mão de obra.",
  "top_customers": "Máximo de clientes por quantidade total quando não há filtro customer_codes/customer_names (padrão 20, máximo 100).",
...
export const ENUM_OPTION_LABELS: Record<string, Record<string, string>> = {
  ...
  export_format: { "csv": "CSV", "xlsx": "Excel" },
  ...
  group_by: { "branch": "Filial", "branch_summary": "Resumo por filial", "center": "Centro do cliente", "center_product": "Centro do cliente e produto", "customer": "Cliente", "day": "Dia", "day_work_center": "Dia × centro de trabalho", "general": "Geral", "none": "Nenhum", "product": "Produto", "product_group": "Grupo de produto", "unit": "Unidade" },
  include: { "portfolio": "Carteira semanal" },
  ...
  market: { "domestic": "Interno", "export": "Externo" },
  ...
  party_type: { "customer": "Cliente", "supplier": "Fornecedor" },
