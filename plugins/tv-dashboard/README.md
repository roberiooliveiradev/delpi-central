...
- **Pasteboard / paridade:** editor e TV usam `overflow:visible` na moldura — itens fora do 1080p aparecem no letterbox; clip só na borda física. Ver `.cursor/rules/tv-dashboard-editor-pasteboard.mdc`
