...
export function HelpTooltip({
  ...
  const rootClass = [
    "kz-help-tooltip",
    wrap ? "kz-help-tooltip--wrap" : "",
    visible ? "kz-help-tooltip--open" : "",
    className,
  ]
    .filter(Boolean)
    .join(" ");
  ...
  const bubbleClass = [
    "kz-help-tooltip__bubble",
    bubblePosition?.placement === "top"
      ? "kz-help-tooltip__bubble--placement-top"
      : "kz-help-tooltip__bubble--placement-bottom",
    positioned ? "kz-help-tooltip__bubble--ready" : "",
  ]
    .filter(Boolean)
    .join(" ");
    ...
    >
      {wrap ? (
        ...
        <button
          ref={triggerRef}
          type="button"
          className="kz-help-tooltip__trigger"
...
export function FieldLabel({
  ...
  return (
    <label className="kz-field__label" htmlFor={htmlFor}>
      {label}
