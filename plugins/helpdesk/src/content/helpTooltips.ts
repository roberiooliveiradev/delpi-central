export const helpTooltips = {
  ...
  detail:
    "A conversa preenche a tela e rola; a resposta fica no rodapé. A foto das suas mensagens é a da Minha DELPI. A seta volta à lista; o ícone de enviar grava a resposta. Imagens abrem em prévia. Não dá para enviar arquivo novo por aqui.",
};
