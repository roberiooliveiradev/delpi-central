...
export function HelpTooltip({
  ...
  const rootClass = [
    "dh-help-tooltip",
    wrap ? "dh-help-tooltip--wrap" : "",
    visible ? "dh-help-tooltip--open" : "",
    className,
  ]
    .filter(Boolean)
    .join(" ");
  ...
  const bubbleClass = [
    "dh-help-tooltip__bubble",
    "dh-help-tooltip__bubble--fixed",
    bubblePosition?.placement === "top"
      ? "dh-help-tooltip__bubble--placement-top"
      : "dh-help-tooltip__bubble--placement-bottom",
    positioned ? "dh-help-tooltip__bubble--ready" : "",
  ]
    .filter(Boolean)
    .join(" ");
    ...
    >
      {wrap ? (
        ...
        <button
          ref={triggerRef}
          type="button"
          className="dh-help-tooltip__trigger"
...
export function FieldLabel({ label, hint }: { label: string; hint?: string }) {
  return (
    <span className="dh-field__label">
      {label}
