"""Layout HTML de e-mail do Comitê de Ética — faixa colorida + rodapé (Outlook-safe).
...
LOGO_CONTENT_ID = "cec-logo"


class CecEmailBrandLayoutService:
    """Envelope de marca para e-mails do CEC."""
        ...
        *,
        ...
        if logo_content_id:
            logo = (
                ...
                'alt="Comitê de Ética e Conduta" width="72" height="72" '
