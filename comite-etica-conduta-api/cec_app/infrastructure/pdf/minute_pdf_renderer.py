...
_LOGO_PATH = _ASSETS_DIR / "logo-comite_etica.png"
...
_UNIT_LABELS = {
    "00": ("Comitê de Ética e Conduta", "Comitê de Ética e Conduta"),
...
def _block_style(
    ...
    style = ParagraphStyle(f"CecRichText-{tag}", parent=body_style)
    if tag != "p":
...
class MinutePdfRenderer:
    def render(
        ...
        doc = SimpleDocTemplate(
            ...
            topMargin=43 * mm,
            bottomMargin=25 * mm,
            title=f"Ata CEC {minute.get('minute_number') or ''}",
    ...
    def _styles(self) -> dict[str, ParagraphStyle]:
        ...
        return {
            ...
            "body": ParagraphStyle(
                ...
                # com o espelho web (`.comite_etica-minute-document__content > p`).
    ...
    def _story(
        ...
        story: list[Flowable] = [
            Paragraph("ATA DE REUNIÃO DA CEC", styles["title"]),
