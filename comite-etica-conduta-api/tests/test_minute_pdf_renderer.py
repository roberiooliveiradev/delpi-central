...
from cec_app.infrastructure.pdf.minute_pdf_renderer import (
    MinutePdfRenderer,
...
def test_document_formatters_are_locale_independent():
    ...
    assert role_label("vice_president") == "Vice-presidente"
    assert role_label("member") == "Membro"
...
def test_renderer_builds_formal_pdf_with_participants_and_signers():
    ...
    raw = renderer.render(
        ...
        [{"user_id": "user-1", "display_name": "Pessoa CEC", "sign_order": 1}],
        [],
    )
