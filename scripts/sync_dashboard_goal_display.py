#!/usr/bin/env python3
"""Replica goalDisplay.ts do commercial para os demais dashboards."""
...
SOURCE = ROOT / "plugins/dashboard-commercial/src/utils/goalDisplay.ts"
...
def main() -> None:
    ...
    for plugin in TARGET_PLUGINS:
        target = ROOT / plugin / "src/utils/goalDisplay.ts"
