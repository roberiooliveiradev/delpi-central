...
from app.interfaces.http.admin.rbac_controller import rbac_admin_bp
from app.interfaces.http.admin.apps_controller import apps_admin_bp
from app.interfaces.http.admin.routes_controller import routes_admin_bp
from app.interfaces.http.plugins.lifecycle_controller import plugins_bp
