...
class Settings:
    MAINT_API_ROOT_PATH: str = _get_env("MAINT_API_ROOT_PATH", default="/apps/maintenance-api")
    ...
    MAINT_RUN_MIGRATIONS_ON_STARTUP: bool = (
        str(_get_env("MAINT_RUN_MIGRATIONS_ON_STARTUP", default="false") or "false").lower()
        in {"1", "true", "yes", "on"}
    )
    ...
    DELPI_API_CALLER_APP: str = _get_env("DELPI_API_CALLER_APP", default="maintenance-api")
