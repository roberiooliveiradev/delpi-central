...
class ProductionPulseRealtimeHub:
    """Salas WebSocket: user:{userId}, branch:{01|02}, device:{id}, ota.job:{id}."""
    ...
    async def worker(self) -> None:
        ...
        while True:
            ...
            try:
                ...
                logger.exception("production_pulse_realtime_broadcast_failed")
        ...
        try:
            ...
            while True:
                try:
                    ...
                    logger.info("production_pulse_realtime_idle_timeout user_id=%s", uid)
...
production_pulse_realtime_hub = ProductionPulseRealtimeHub()
