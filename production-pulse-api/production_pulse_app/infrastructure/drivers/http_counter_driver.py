...
class HttpCounterDriver:
    """Shared HTTP protocol for pulse-counter devices (ESP8266 / ESP32-C3)."""
    ...
    def _timeout_for(self, device: dict[str, Any]) -> float:
        ...
        driver_key = str(device.get("driver_key") or device.get("driverKey") or self._driver_key)
...
__all__ = ["HttpCounterDriver", "parse_controller_identity"]
