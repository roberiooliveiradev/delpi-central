...
class Settings:
    REQUESTS_API_ROOT_PATH: str = _get_env(
        "REQUESTS_API_ROOT_PATH",
        default="/apps/requests-api",
    )
    ...
    REQUESTS_RUN_MIGRATIONS_ON_STARTUP: bool = (
        str(_get_env("REQUESTS_RUN_MIGRATIONS_ON_STARTUP", default="false") or "false").lower()
        in {"1", "true", "yes", "on"}
    )
    ...
    DELPI_API_CALLER_APP: str = _get_env("DELPI_API_CALLER_APP", default="requests-api")
