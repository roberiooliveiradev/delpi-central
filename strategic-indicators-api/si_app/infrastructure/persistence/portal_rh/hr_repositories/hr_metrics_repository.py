...
from si_app.infrastructure.persistence.portal_rh.portal_rh_base_repository import (
    PortalRhBaseRepository,
)


PDI_ACTIVE_INDICATOR_CODE = "PDI_ATV"
# Portal RH: id=7, code DES_AVL (% avaliações no prazo, já calculado em monthlyactual).
# AVA_DES mantido como alias legado.
PERFORMANCE_REVIEWS_INDICATOR_CODES = ("DES_AVL", "AVA_DES")
...
class HrMetricsRepository(PortalRhBaseRepository):
    ...
    def get_performance_reviews_completion_snapshot(
        ...
        *,
        ...
        return {
            "indicator_code": PERFORMANCE_REVIEWS_INDICATOR_CODES[0],
            "branch_code": branch_code,
