...
PLUGINS_DB_POOL_MAX_SIZE = int(os.getenv("PLUGINS_DB_POOL_MAX_SIZE", "5") or "10")
PLUGINS_DB_POOL_ACQUIRE_TIMEOUT = float(
    os.getenv("PLUGINS_DB_POOL_ACQUIRE_TIMEOUT", "30") or "30"
)
PLUGINS_DB_APPLICATION_NAME = (
    os.getenv("PLUGINS_DB_APPLICATION_NAME", "strategic-indicators-api-plugins").strip()
    or "strategic-indicators-api-plugins"
)
...
class PluginsDbSettings:
    ...
    sslmode: str = "prefer"
    application_name: str = "strategic-indicators-api-plugins"
