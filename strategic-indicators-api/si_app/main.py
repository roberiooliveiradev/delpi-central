...
from si_app.interface.http.routes.integrations_indicator_metric_routes import (
    meta_router as strategic_indicators_indicator_meta_router,
    realized_router as strategic_indicators_indicator_realized_router,
)
...
app.include_router(strategic_indicators_indicator_realized_router)
app.include_router(strategic_indicators_indicator_meta_router)
