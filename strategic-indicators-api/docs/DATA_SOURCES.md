...
| Comercial | TOTVS: ROL matriz/filial, taxa fechamento, % ROL novos negócios (exclui WEG: código 000001 ou nome). **Pendente:** OTD pedidos venda. Catálogo V015. | `commercial_indicators_snapshot_provider` |
