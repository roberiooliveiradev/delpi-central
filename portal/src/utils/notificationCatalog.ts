...
export const FALLBACK_NOTIFICATION_CATALOG: NotificationCatalogResponse = {
  ...
  categories: [
    ...
    { id: "invoice_issuance", label: "Emissão de Notas Fiscais (legado)", notificationLabel: "Solicitações de emissão de NF", icon: "file-text", mutable: true, kind: "app", sourceApps: ["my-requests", "invoice-issuance"], pluginId: "my-requests" },
    ...
    { id: "portal_rh", label: "Portal RH", notificationLabel: "Avisos do Portal RH", icon: "file-user", mutable: true, kind: "app", sourceApps: ["rhdelpi", "portal-rh"], pluginId: "rhdelpi" },
  ],
