...
| 4 — Interatividade | **Em andamento** — filtros por categoria; **explicar gráfico inline** (`chartExplanation` + chip `inlineAction: explain_chart` + botão Explicar); drill-down, zoom, export PNG/lousa |
