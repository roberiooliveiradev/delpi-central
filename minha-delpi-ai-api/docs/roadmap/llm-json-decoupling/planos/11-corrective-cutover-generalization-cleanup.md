...
**Status:** **ATENDIDO** · `METAMORPHIC_PROVIDER_PATH_OPERATION_ID_RENAME=PASS` · evidência [`../evidence/e11-j-r5-metamorphic-rename.md`](../evidence/e11-j-r5-metamorphic-rename.md)

**Gate:** `METAMORPHIC_PROVIDER_PATH_OPERATION_ID_RENAME = PASS` (**cumprido**).
...
- path/method/operationId permanecem só para execução/contrato/observabilidade.

**Status:** **ATENDIDO** · `NO_PATH_SEMANTIC_AFFINITY=PASS` · evidência [`../evidence/e11-j-r7-zero-path-semantic-affinity.md`](../evidence/e11-j-r7-zero-path-semantic-affinity.md)

**Gate:** `NO_PATH_SEMANTIC_AFFINITY = PASS` (**cumprido**).

**Próxima:** J-R9 (após J-R8 ATENDIDO).
...
**Status:** **ATENDIDO** — ver [`../evidence/e11-j-r8-technical-parallel-registry-cleanup.md`](../evidence/e11-j-r8-technical-parallel-registry-cleanup.md). Manual `operationIds`/`method`/`pathPrefixToDepartmentId` removidos; autoTierC CI classificado `JUSTIFIED_NON_SEMANTIC`.
