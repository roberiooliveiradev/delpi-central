...
**Status:** Onda A–G ATENDIDAS · Onda H **ATENDIDO_PARCIAL** (E9.S1–S11; DELETE/release ainda abertos) · via [`evidence/execution-ledger.md`](./evidence/execution-ledger.md)  
