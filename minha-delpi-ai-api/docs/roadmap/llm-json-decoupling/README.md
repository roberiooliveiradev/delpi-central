...
**Status:** Onda A–G ATENDIDAS · Onda H **ATENDIDO_PARCIAL** (E9.S1–S12.A–E JSON DELETE; TU/cutover ainda aberto) · via [`evidence/execution-ledger.md`](./evidence/execution-ledger.md)  
