...
### Onda G — apresentação e conteúdo residual — **EM_ANDAMENTO** (E7.S1–S3 ATENDIDO)

Plano 07: inventário + baseline + shape-first unknown OK. Próximo: E7.S4 path/entity cleanup com equivalência.
