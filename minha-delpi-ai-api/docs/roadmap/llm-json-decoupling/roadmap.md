...
### Onda H — cutover e limpeza — **EM_ANDAMENTO** (E9.S1–S8 parcial)

Verify-final offline com `globalReleasePass=false`. Próximo: E9.S9 docs. DELETE legado e aceite final só com gates/live plenos.
