...
### Onda G — apresentação e conteúdo residual — **EM_ANDAMENTO** (E7.S1–S2 ATENDIDO)

Plano 07: inventário + baseline OK. Próximo: E7.S3 fortalecer shape defaults. Plano 08 após cutover parcial ou em paralelo controlado.
