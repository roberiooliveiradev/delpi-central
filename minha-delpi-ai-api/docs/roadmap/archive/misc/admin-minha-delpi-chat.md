...
- [Revisão de fluxos (set/2026)](../../active/admin-fluxos-revisao.md) — manter / melhorar / remover da jornada
- [Melhorias futuras](../../active/melhorias-futuras.md)
...
**Status: Concluído** (health dedicado por tool: evolução futura — ver [melhorias-futuras](../../active/melhorias-futuras.md))
...
Itens listados historicamente em [melhorias-futuras.md](../../active/melhorias-futuras.md) (thumbs, `GET /admin/tools/health`, simulação com sessão/sandbox, etc.) estão **concluídos** no escopo do chat; permanece pendente externo: RBAC com perfis formais no `core-api`.

Veredito atual de produto (manter / melhorar / remover da jornada): **[admin-fluxos-revisao.md](../../active/admin-fluxos-revisao.md)** (set/2026 — documentação apenas).

---

# Próxima ação recomendada

1. Seguir o backlog em [admin-fluxos-revisao.md](../../active/admin-fluxos-revisao.md) §6 (Studio de agente → Observe → fine-tune honesto → Ajuda in-app) — **só após decisão de implementar código**.
