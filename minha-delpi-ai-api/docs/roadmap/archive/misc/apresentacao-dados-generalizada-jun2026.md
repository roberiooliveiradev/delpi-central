...
Relacionado: [playbook-09-apresentacao-rica.md](../playbooks/playbook-09-apresentacao-rica.md), [chat-assistant-content-presentation.md](../../../architecture/presentation-intelligence.md), [playbook-10-contrato-respostas-api-delpi.md](../playbooks/playbook-10-contrato-respostas-api-delpi.md), [vocabulary-centralization-jun2026.md](../../../architecture/archive/vocabulary-centralization-jun2026.md).
...
**Narrativa humanizada (jun/2026):** ver [`humanized-narrative-stack-jun2026.md`](../../../architecture/presentation-intelligence.md) — texto interpretativo obrigatório antes de painéis; default `selected=text` + `layoutMode=stack` em rotas ricas.
...
**Playbook:** [playbook-12-apresentacao-declarativa-refatoracao.md](../playbooks/playbook-12-apresentacao-declarativa-refatoracao.md) — fases R0–R9 (`role` em tabelas, registry de bundles, table assembly, section availability declarativa, presenters unificados, MFE sem re-decidir formato).
...
| Artefato | Caminho |
|----------|---------|
| Serviço | `app/domain/services/chat_schema_driven_presentation_service.py` |
| Templates | `presenter_content.json` → `schemaDriven.*` |
