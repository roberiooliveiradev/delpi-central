...
| [Onda 11 — paridade assistentes](../waves/inteligencia-chat-onda-11-paridade-assistentes.md) | Native tool calling — validar no provider externo |
| [Onda 13 — visão documentos](../../active/inteligencia-chat-onda-13-skill-visao-documentos-ocr.md) | P3 deste playbook |
| [RAG calibração](../misc/rag-context-min-score-calibracao.md) | `OLLAMA_NUM_CTX` → generalizar para perfil de latência |
