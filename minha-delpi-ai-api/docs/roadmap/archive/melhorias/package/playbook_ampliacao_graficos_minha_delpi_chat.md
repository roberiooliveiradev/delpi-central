...
> **Status (03/06/2026):** [Concluído (MVP)](./STATUS_ROADMAP_MELHORIAS.md) — Fases **1–4** + `AgentMiniDashboard`; apresentação rica F1–6 em [`playbook-09-apresentacao-rica.md`](../../playbooks/playbook-09-apresentacao-rica.md). Backlog: refinamentos PNG multi-painel.
...
No front, **`ChatAssistantContent`** centraliza narrativa + troca entre tabela, gráfico e árvore (`AssistantContentFormatToolbar`), usando `ChatRichChart`, `ChatRichTable`, `ChatRichKpi` e `ChatRichTree`. Ver [`../../architecture/presentation-intelligence.md`](../../architecture/presentation-intelligence.md).
