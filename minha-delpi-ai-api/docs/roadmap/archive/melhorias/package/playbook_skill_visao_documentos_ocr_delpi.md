...
> **Status (jun/2026):** MVP entregue (Onda 13) + **extração PDF no chat base** (`ChatPdf*`, jun/2026). Refinamentos: profile `vision` em homologação, OCR hierárquico desenhos na [Onda 14](../../../active/inteligencia-chat-onda-14-ocr-hierarquico-desenhos.md).  
...
> **Roadmap sugerido:** [Onda 13](../../../active/inteligencia-chat-onda-13-skill-visao-documentos-ocr.md) (criar após aprovação deste playbook).
...
| **13.5 — VLM Ollama** | Backend `ollama_vlm` opt-in; cotas com confidence | **13.5.1 ✅** (fallback `auto`) |
...
**Evolução pós-MVP (jun/2026):** regiões gráficas corretas (carimbo **base direita**), BOM/cotas separados e resolução de código DELPI — [Onda 14](../../../active/inteligencia-chat-onda-14-ocr-hierarquico-desenhos.md) · [playbook OCR hierárquico](./playbook_ocr_hierarquico_desenhos_delpi.md).
...
| [inteligencia-chat-onda-12-...](../../../active/inteligencia-chat-onda-12-skill-analise-desenhos-pdf.md) | 12.2.x passa a delegar para Onda 13 |
