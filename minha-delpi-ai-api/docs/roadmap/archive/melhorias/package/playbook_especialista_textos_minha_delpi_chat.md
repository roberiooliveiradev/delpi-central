...
**Status (03/06/2026):** **Concluído** (Fases 1–7) — especificação consolidada em [`playbook-especialista-editor-textos.md`](../../playbooks/playbook-especialista-editor-textos.md).  
