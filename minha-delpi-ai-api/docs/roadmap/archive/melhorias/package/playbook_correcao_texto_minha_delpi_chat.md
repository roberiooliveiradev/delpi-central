...
**Arquitetura:** [`docs/architecture/chat-intelligence-base.md`](../../architecture/chat-intelligence-base.md) — inteligência no chat base; ver também [`playbook_assistente_administrativo_textos_minha_delpi_chat.md`](./playbook_assistente_administrativo_textos_minha_delpi_chat.md) (modo administrativo/textual) e [**Playbook 14** — typos no composer](../../playbooks/playbook-14-corretor-digitacao-chat.md) (distinto desta habilidade LLM).
...
| Erro ao digitar «estouque do produto…» | [**Playbook 14**](../../playbooks/playbook-14-corretor-digitacao-chat.md) — chip pré-envio determinístico |
