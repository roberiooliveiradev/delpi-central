...
| QTD OCR da descrição → crítico BOM falso | 15.8 | `test_chat_drawing_validation_90263149.py` |
| Skill pede print em vez de re-OCR | 15.8.5 | `drawing-analysis-delpi-skill.md` + JSON |
...
| [inteligencia-chat-onda-12-skill-analise-desenhos-pdf.md](../../../active/inteligencia-chat-onda-12-skill-analise-desenhos-pdf.md) | MVP skill + validação |
| [inteligencia-chat-onda-14-ocr-hierarquico-desenhos.md](../../../active/inteligencia-chat-onda-14-ocr-hierarquico-desenhos.md) | Extração que alimenta validação |
