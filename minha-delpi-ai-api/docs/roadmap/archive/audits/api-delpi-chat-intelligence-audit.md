...
Itens 1–5 abaixo foram entregues na **Onda 11** — ver [inteligencia-chat-onda-11-paridade-assistentes.md](../waves/inteligencia-chat-onda-11-paridade-assistentes.md).
...
**Entregue jun/2026:** [Playbook 15](../playbooks/playbook-15-rotas-operacionais-sem-sql.md) — 15 rotas REST + seleção determinística no chat base.

**Próximas ondas:** [Onda 14](../../active/inteligencia-chat-onda-14-ocr-hierarquico-desenhos.md) (BOM/cotas OCR), [Onda 12](../../active/inteligencia-chat-onda-12-skill-analise-desenhos-pdf.md) refinamentos.
