...
| [inteligencia-chat-onda-13-skill-visao-documentos-ocr.md](./inteligencia-chat-onda-13-skill-visao-documentos-ocr.md) | **Onda 13 (backlog):** skill `document-vision-delpi` — [playbook OCR/visão](./melhorias/playbook_skill_visao_documentos_ocr_delpi.md); alimenta desenho e anexos. |
