...
| [inteligencia-chat-onda-14-ocr-hierarquico-desenhos.md](./inteligencia-chat-onda-14-ocr-hierarquico-desenhos.md) | **Onda 14 (backlog):** OCR hierárquico carimbo/BOM/cotas — [playbook](./melhorias/playbook_ocr_hierarquico_desenhos_delpi.md); corrige extração de código do desenho (baseline 4/13 PDFs reais). |
...
| [playbook-15-rotas-operacionais-sem-sql.md](./playbook-15-rotas-operacionais-sem-sql.md) | **Playbook 15 (roadmap):** rotas api-delpi produção/consumo/compras/perdas — eliminar inferência SQL; [api-delpi](../../../api-delpi/docs/roadmaps/playbook-producao-consumo-compras-perdas-op.md) + [chat](./playbook-15-chat-integracao-producao-suprimentos.md). |
| [playbook-15-anexo-catalogo-exclusividade-mp.md](./playbook-15-anexo-catalogo-exclusividade-mp.md) | **Anexo Playbook 15:** catálogo MP exclusiva × PA — [api-delpi](../../../api-delpi/docs/roadmaps/playbook-catalogo-exclusividade-mp.md). |
...
| [playbook-17-importacao-arquivos-e-fontes-unificada.md](./playbook-17-importacao-arquivos-e-fontes-unificada.md) | **Playbook 17 (roadmap):** unificar dropzone/card/status/poll das 5 famílias de ingestão de arquivos (anexo, agente, projeto, admin, contexto). |
