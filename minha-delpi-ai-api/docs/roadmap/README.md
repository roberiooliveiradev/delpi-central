...
| [playbook-15-rotas-operacionais-sem-sql.md](./playbook-15-rotas-operacionais-sem-sql.md) | **Playbook 15 (concluído):** 15 rotas api-delpi + chat base; [api-delpi](../../../api-delpi/docs/roadmaps/playbook-producao-consumo-compras-perdas-op.md) + [13-producao-operacional](../../../api-delpi/docs/api/13-producao-operacional.md). |
...
| [playbook-24-llm-provider-pluggable-jul2026.md](./playbook-24-llm-provider-pluggable-jul2026.md) | **Playbook 24 (proposta jul/2026):** provedores LLM plugáveis — Ollama padrão; texto/embeddings/VLM trocáveis por API externa (P0–P5). |
