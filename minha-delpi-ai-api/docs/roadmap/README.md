...
| [docie-desacoplamento-selecao-rotas-openapi.md](./docie-desacoplamento-selecao-rotas-openapi.md) | **DOCIE histórico/transição:** mapa de acoplamentos api-delpi e evolução declarativa anterior; para a próxima arquitetura universal usar o prompt mestre Set/2026 acima. |
