...
| [inteligencia-chat-onda-12-skill-analise-desenhos-pdf.md](./inteligencia-chat-onda-12-skill-analise-desenhos-pdf.md) | **Onda 12 (backlog):** skill `drawing-analysis-delpi` — [playbook](./melhorias/playbook_skill_analise_desenhos_delpi.md); PDF × API × normas; herdável por agentes. |
