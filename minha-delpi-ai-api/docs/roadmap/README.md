...
| [playbook-16-openapi-import-async-e-readiness-operacional.md](./playbook-16-openapi-import-async-e-readiness-operacional.md) | **Playbook 16 (roadmap):** import OpenAPI async + progresso UI + readiness pós-deploy (3 camadas API → catálogo → agente). |
