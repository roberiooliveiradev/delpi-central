...
| [03 — Especialista textos](./playbook_especialista_textos_minha_delpi_chat.md) | Implementado (F1–7) | T1–T20, [`playbook-especialista-editor-textos.md`](../playbook-especialista-editor-textos.md), `textAssistant` metadata, chips por subtipo |
