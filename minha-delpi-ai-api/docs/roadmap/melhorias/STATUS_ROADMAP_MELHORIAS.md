...
| [playbook_correcao_texto_minha_delpi_chat.md](./playbook_correcao_texto_minha_delpi_chat.md) | Parcial | Fases 1–4 (subtipos, validador, chips MFE); Fase 5 memória backlog |
