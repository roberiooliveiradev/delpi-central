...
| [playbook_autoajuda_autoconhecimento_chat_minha_delpi.md](./playbook_autoajuda_autoconhecimento_chat_minha_delpi.md) | Parcial | Fases 1–2 (catálogo + registry); Fases 3–5 backlog |
