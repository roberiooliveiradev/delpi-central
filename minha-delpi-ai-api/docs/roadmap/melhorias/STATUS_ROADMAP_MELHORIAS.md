...
| [playbook_ampliacao_graficos_minha_delpi_chat.md](./playbook_ampliacao_graficos_minha_delpi_chat.md) | Parcial | Fases 1–2 (tipos de gráfico + seleção automática); 3–5 backlog |
