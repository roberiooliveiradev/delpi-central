...
| [playbook_skill_analise_desenhos_delpi.md](./playbook_skill_analise_desenhos_delpi.md) | Parcial | Fases 1–3: BOM/50xx/cotas, símbolos ✅⚠️❌; export UI e fixtures PDF pendentes |
