...
| [playbook-memoria-e-contexto.md](../playbook-memoria-e-contexto.md) | Fases 1–2 concluídas | `ChatConversationStateService`, `ChatEntityTrackerService` · Fases 3–9 backlog |
