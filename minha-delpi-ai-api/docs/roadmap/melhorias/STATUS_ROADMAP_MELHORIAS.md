...
| [playbook_autoajuda_autoconhecimento_chat_minha_delpi.md](./playbook_autoajuda_autoconhecimento_chat_minha_delpi.md) | Parcial | Fase 1 iniciada (`webSearchHelp` em capabilities) |
