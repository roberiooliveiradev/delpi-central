...
| [playbook-memoria-e-contexto.md](../playbook-memoria-e-contexto.md) | Fase 1 concluída | `ChatConversationStateService` · Fases 2–9 backlog · `run_memory_context_validation.sh` |
