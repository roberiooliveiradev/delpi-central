...
| [playbook_skill_analise_desenhos_delpi.md](./playbook_skill_analise_desenhos_delpi.md) | Parcial | MVP Fase 1: intent, skill catálogo, `/analyser`, relatório `drawingAnalysis`; OCR PDF Fase 2+ |
