...
| **Follow-up operacional desacoplado (jun/2026)** | [playbook-follow-up-operacional-desacoplado-jun2026.md](./playbook-follow-up-operacional-desacoplado-jun2026.md) | **P0 + P1.0** — expedição, exclusividade, parâmetros estritos, herança de data |
