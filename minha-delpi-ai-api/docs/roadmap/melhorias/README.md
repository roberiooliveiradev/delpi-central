...
| Assistente administrativo (textos) | [playbook_assistente_administrativo_textos_minha_delpi_chat.md](./playbook_assistente_administrativo_textos_minha_delpi_chat.md) | Menu **Textos** no MFE (F1–2); núcleo textual **Concluído** em [`playbook-especialista-editor-textos.md`](../playbook-especialista-editor-textos.md) |
