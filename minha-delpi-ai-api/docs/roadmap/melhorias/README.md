...
| Correção de texto | [playbook_correcao_texto_minha_delpi_chat.md](./playbook_correcao_texto_minha_delpi_chat.md) | Fases **1–4** (`ChatTextCorrection*`); Fase 5 memória backlog |
