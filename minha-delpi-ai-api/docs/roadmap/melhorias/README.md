...
| Typos no composer (pré-envio) | [playbook-14-corretor-digitacao-chat.md](../playbook-14-corretor-digitacao-chat.md) | **Implementado** — chip + `POST /chat/typing-suggestions` |
