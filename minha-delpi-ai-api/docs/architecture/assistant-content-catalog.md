...
| `product_operational_content.json` | Produto: escopos, plural, presenter estoque, presentation MFE, `paginationDefaults` (page_size hierárquico/padrão) | `ChatProductOperationalContentService`, plural, multi-scope, catálogo de rotas produto |
