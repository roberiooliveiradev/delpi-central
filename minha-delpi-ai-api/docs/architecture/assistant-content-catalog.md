...
| `response_mode_synthesis_quality.json` | Critérios smoke/regressão da síntese LLM (similaridade vs template, contexto, deflexão, **`coherenceChecks`**, escada de modos) | `ChatResponseModeSynthesisQualityContentService`, `ChatResponseModeSynthesisQualityService` |
