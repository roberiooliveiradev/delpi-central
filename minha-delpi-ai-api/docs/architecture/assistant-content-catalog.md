...
| `technical_description_vocabulary.json` | Normas técnicas MP: grupos 1001–1025, campos, abreviações de cor, marcadores de intent | `ChatTechnicalDescriptionVocabularyService`, `ChatTechnicalDescriptionIntentService` |
