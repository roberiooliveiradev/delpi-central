> **Origem:** `api-delpi-py/GPT_instructions/drawing_rules_delpi.md` · **Adaptado em:** 2026-05-29 18:03 UTC · **Alvo:** agente Minha DELPI / RAG operacional
>
...
| **Descrição** | Nome completo | TERM. TUBULAR 0,34MM2 COMP 8MM ESTANHADO |
