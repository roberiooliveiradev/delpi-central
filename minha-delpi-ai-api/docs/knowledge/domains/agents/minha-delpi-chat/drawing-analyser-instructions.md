> **Origem:** `api-delpi-py/GPT_instructions/drawing_analyser_instructions.md` · **Adaptado em:** 2026-06-09 02:51 UTC · **Alvo:** agente Minha DELPI / RAG operacional
>
...
| **PDF / revisão** | REV. no desenho é do **cliente**; revisão Delpi só no TOTVS (`B1_REVATU`) — não comparar | Exibir ambos no relatório; **nunca** crítico por divergência |
...
| Bitola (mm2 ou AWG) | Conferir com SB1010 | SB1010 |
...
| **Cor e Bitola** | CB1,50VERD | ✅ OK | Cabo EPR 1,5mm2 verde | SB1010 |
