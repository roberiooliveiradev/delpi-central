> **Origem:** `api-delpi-py/GPT_instructions/drawing_requirements_delpi.md` · **Adaptado em:** 2026-05-29 18:03 UTC · **Alvo:** agente Minha DELPI / RAG operacional
>
...
| **REVISÃO** | No da revisão e breve descrição | Ex.: R01 – Ajuste de bitola |
