"""Cumprimentos e interações triviais respondem direto, sem LLM."""
...
def test_stream_greeting_uses_direct_answer_without_llm_or_rag_or_agentic():
    session = _session()
    ...
    assert "consultar" in done["answer"].lower() or "ajudar" in done["answer"].lower()
