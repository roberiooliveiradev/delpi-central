...
def test_analyser_guide_and_inspection_use_tables_not_raw_dict():
...
def test_analyser_text_presentation_aligns_with_body():
    ...
    root = presenter._normalize_analyser_root(payload)
    product = root["product"]

    text = presenter._build_product_analyser_text_presentation(
        root,
        product,
        "/products/90260140/analyser",
    )
