...
class OperationalResponseProfile:
    entity: str | None
    shape: str | None
...
class ChatOperationalResponseProfileService:
    ...
    @classmethod
    def resolve(cls, data: Any, *, path: str = "") -> OperationalResponseProfile:
        ...
        return OperationalResponseProfile(
            entity=entity,
            shape=shape,
