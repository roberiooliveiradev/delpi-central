...
class ChatFollowUpTurnInterpretationService:
    ...
    def interpret(
        ...
        *,
        ...
        slot_delta = cls._extract_slot_delta(typo_fixed, typo_normalized)
    ...
    @classmethod
    def _extract_slot_delta(cls, message: str, normalized: str) -> dict[str, str]:
        delta: dict[str, str] = {}
    ...
    def _is_topic_switch(cls, normalized: str, last_action: dict[str, Any]) -> bool:
        action_blob = " ".join(
            ...
            for key in ("path", "name", "operationId", "operation_id")
        ).lower()
