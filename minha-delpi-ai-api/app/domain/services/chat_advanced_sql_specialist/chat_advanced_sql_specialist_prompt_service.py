...
class ChatAdvancedSqlSpecialistPromptService:
    ...
    def _authoring_context(cls, *, message: str | None, columns: list[str] | None = None) -> dict[str, Any]:
        ...
        return ChatSqlExecutableSynthesisService.build_context(message, columns=columns)
    ...
    def _authoring_sql_from_message(cls, message: str | None, columns: list[str]) -> str | None:
        ...
        return ChatSqlExecutableSynthesisService.synthesize_select(
            message,
            columns=columns,
    ...
    def _wants_recent_order(cls, message: str | None) -> bool:
        ...
        return ChatSqlExecutableSynthesisService._wants_recent_order(message)
