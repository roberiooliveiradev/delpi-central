...
_TYPO_REPLACEMENTS: tuple[tuple[str, str], ...] = (
    ...
    (r"\bajuda\b", r"ajuda"),
    # Hora / data (perguntas utilitárias)
    (r"\bq horas\b", r"que horas"),
    (r"\bq hrs\b", r"que horas"),
    (r"\bq hora\b", r"que hora"),
    (r"\bhors\b", r"horas"),
    (r"\bhorass\b", r"horas"),
    (r"\boras\b", r"horas"),
    (r"\bhoras sao\b", r"horas sao"),
    (r"\brelojo\b", r"relogio"),
    (r"\brelgio\b", r"relogio"),
    (r"\bhorrio\b", r"horario"),
    (r"\bhoraro\b", r"horario"),
    (r"\bhj\b", r"hoje"),
    (r"\bhje\b", r"hoje"),
    (r"\bq dia\b", r"que dia e hoje"),
    (r"\bq data\b", r"qual a data"),
    # Saudações (small talk)
    (r"\bbo dia\b", r"bom dia"),
    (r"\bbao dia\b", r"bom dia"),
    (r"\bbmo dia\b", r"bom dia"),
    (r"\bboa tard\b", r"boa tarde"),
    (r"\bboa noit\b", r"boa noite"),
    (r"\bobg\b", r"obrigado"),
