...
| **Revisão sem carimbo legível** | **Pendente** (`revision_manual_pending`) quando texto do carimbo não atinge marcadores mínimos (`nativeTextGate`) ou parece tabela BOM — não crítico automático |
