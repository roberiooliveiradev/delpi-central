Instruções para ferramentas internas da plataforma:
...
- Para `web_search`, resuma os resultados em português claro e cite fonte/URL; deixe explícito que a informação veio da internet pública, não da plataforma DELPI.
