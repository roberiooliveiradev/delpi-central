...
from app.composition.admin_composer import (
    ...
    make_get_admin_session_memory_summary_use_case,
...
@admin_bp.get("/metrics/registry-selection-shadow/summary")
@require_permission(CHAT_ADMIN_PERMISSION)
def admin_registry_selection_shadow_metrics_summary():
    from app.composition.admin_composer import (
        make_get_admin_registry_selection_shadow_summary_use_case,
    )

    use_case = make_get_admin_registry_selection_shadow_summary_use_case()
    hours_raw = request.args.get("hours", 168)
...
@admin_bp.get("/metrics/interactivity/summary")
@require_permission(CHAT_ADMIN_PERMISSION)
def admin_interactivity_metrics_summary():
    from app.composition.admin_composer import make_get_admin_interactivity_summary_use_case

    use_case = make_get_admin_interactivity_summary_use_case()
    hours_raw = request.args.get("hours", 168)
...
@admin_bp.get("/metrics/presentation/summary")
@require_permission(CHAT_ADMIN_PERMISSION)
def admin_presentation_metrics_summary():
    from app.composition.admin_composer import make_get_admin_presentation_summary_use_case

    use_case = make_get_admin_presentation_summary_use_case()
    hours_raw = request.args.get("hours", 168)
...
def admin_error_handling_metrics_summary():
    from app.composition.admin_composer import make_get_admin_error_handling_summary_use_case

    use_case = make_get_admin_error_handling_summary_use_case()
    hours_raw = request.args.get("hours", 168)
...
@admin_bp.get("/metrics/web-search/summary")
@require_permission(CHAT_ADMIN_PERMISSION)
def admin_web_search_metrics_summary():
    from app.composition.admin_composer import make_get_admin_web_search_summary_use_case

    use_case = make_get_admin_web_search_summary_use_case()
    hours_raw = request.args.get("hours", 168)
...
@admin_bp.get("/metrics/session-memory/summary")
@require_permission(CHAT_ADMIN_PERMISSION)
def admin_session_memory_metrics_summary():
    use_case = make_get_admin_session_memory_summary_use_case()
    hours_raw = request.args.get("hours", 168)
