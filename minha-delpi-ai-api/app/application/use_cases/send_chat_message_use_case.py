...
from app.application.services.chat_turn.chat_send_turn_execution_service import (
    ChatSendTurnExecutionDeps,
    ChatSendTurnExecutionService,
)
...
# Reexports para monkeypatch de testes.
__all__ = [
...
class SendChatMessageUseCase:
    def __init__(
        ...
        self._send_deps = ChatSendTurnExecutionDeps(
    ...
    def execute(self, request: SendChatMessageRequest) -> SendChatMessageResponse:
        ...
        with llm_generation_scope(generation_config):
            return ChatSendTurnExecutionService.execute_turn(request, self._send_deps)
