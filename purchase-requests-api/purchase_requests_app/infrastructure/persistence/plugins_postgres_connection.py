...
PLUGINS_DB_APPLICATION_NAME = (
    os.getenv("PLUGINS_DB_APPLICATION_NAME", "purchase-requests-api-plugins").strip()
    or "purchase-requests-api-plugins"
)
...
class PluginsDbSettings:
    ...
    sslmode: str = "prefer"
    application_name: str = "purchase-requests-api-plugins"
