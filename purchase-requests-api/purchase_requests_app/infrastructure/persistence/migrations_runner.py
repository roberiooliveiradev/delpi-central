...
def run_migrations() -> None:
    ...
    with get_connection() as conn:
        ...
        if not pending:
            print("[purchase-requests] Nenhuma migration pendente.")
            return

        print("[purchase-requests] Executando migrations...")
        for path in pending:
            apply_migration(conn, path)

        print("[purchase-requests] Migrations aplicadas com sucesso.")
