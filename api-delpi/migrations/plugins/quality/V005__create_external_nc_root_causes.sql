CREATE TABLE IF NOT EXISTS quality.external_nc_root_causes (
    ...
    CONSTRAINT fk_external_nc_root_causes_nonconformity
        FOREIGN KEY (nonconformity_id)
        REFERENCES quality.external_nonconformities (id)
        ON UPDATE RESTRICT
        ON DELETE CASCADE,

    CONSTRAINT ck_external_nc_root_causes_why_level
