...
REFUGOS_SCRAP_COST_PCT_FIELD_LABELS: dict[str, str] = {
    ...
    "records_without_cost": "Registros sem custo",
...
RETRABALHO_REWORK_COST_PCT_FIELD_LABELS: dict[str, str] = {
    ...
    "appointment_count": "Apontamentos",
    "average_cost_per_hour": "Custo médio por hora (R$)",
    "records_without_cost": "Registros sem custo",
}
...
ENGINEERING_TRANSFORMOMETRO_EVOLUCAO_FIELD_LABELS: dict[str, str] = {
    ...
    "periodo": "Período",
    "competencia": "Período",
    "economia_bruta": "Economia",
    "investimento": "Investimento",
    "investimento_total_mes": "Investimento",
    "investimento_unico": "Investimento único",
    "investimento_unico_mes": "Investimento único",
    "custo_recorrente": "Custo recorrente",
    "custo_recorrente_mes": "Custo recorrente",
    "custo_recursos_compartilhados": "Custo recursos compartilhados",
