...
ROUTE_CONTRACTS: dict[str, RouteContract] = {
    ...
    "list_product_inventory_blocks": RouteContract(
        "product_inventory_blocks", "list"
    ),
    ...
    "get_supplies_safety_stock_consumption_analysis_summary": RouteContract(
        "supplies_safety_stock_consumption_analysis_summary", "scalar"
    ),
    "get_supplies_safety_stock_consumption_analysis_items": RouteContract(
        "supplies_safety_stock_consumption_analysis_item", "paged_list"
    ),
    ...
    "export_supplies_purchase_orders": RouteContract(
        "supplies_purchase_order_line_export", "document_export"
    ),
    ...
    "export_supplies_purchase_request_lines": RouteContract(
        "supplies_purchase_request_line_export", "document_export"
    ),
    ...
    "list_supplies_purchase_request_recent_linked_receipts": RouteContract(
        "supplies_purchase_request_linked_receipt", "list"
    ),
    ...
    "export_lmp_nonconformities": RouteContract(
        "lmp_nonconformity_export", "scalar"
    ),
    "import_lmp_nonconformities": RouteContract(
        "lmp_nonconformity_import", "scalar"
    ),
    ...
    "post_mini_applicators_golpes_batch": RouteContract("mini_applicators_golpes", "list"),
    ...
    "get_commercial_rol_by_product": RouteContract(
        "commercial_rol_by_product", "paged_list"
    ),
    "get_commercial_rol_by_customer_center": RouteContract(
        "commercial_rol_by_customer_center", "paged_list"
    ),
    ...
    "get_production_otd": RouteContract("production_otd_detail", "playbook_report"),
    "get_production_consumption_top_items": RouteContract(
        "production_consumption_top_items", "playbook_report"
    ),
    "list_production_machine_program_top_intermediates": RouteContract(
        "production_machine_program_intermediate", "paged_list"
    ),
    ...
    "get_retrabalhos_rework_cost_pct": RouteContract(
        "retrabalho_rework_cost_pct", "scalar"
    ),
    ...
    "get_refugos_scrap_cost_pct": RouteContract("refugos_scrap_cost_pct", "scalar"),
    ...
    "get_production_appointments_finished_ops_series": RouteContract(
        "production_appointments_finished_ops_series", "playbook_report"
    ),
    "list_production_appointments_by_op": RouteContract(
        "production_appointments_by_op", "paged_list"
    ),
    "list_production_appointments_child_ops": RouteContract(
        "production_appointments_child_ops", "paged_list"
    ),
    ...
    "get_kaizen_savings_investment_series": RouteContract(
        "kaizen_savings_investment_series", "scalar"
    ),
    ...
    "get_quality_returned_totals": RouteContract(
        "quality_returned_totals", "playbook_report"
    ),
    ...
    "update_audit_5s_area": RouteContract("audit_5s_area", "scalar"),
    "delete_audit_5s_area": RouteContract("audit_5s_area", "scalar"),
    "set_audit_5s_area_children": RouteContract("audit_5s_area", "scalar"),
