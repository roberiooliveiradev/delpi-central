...
PRODUCTION_APPOINTMENTS_FINISHED_OPS_GRANULARITY_VALUES = ("day", "month")
...
def PRODUCTION_APPOINTMENTS_FINISHED_OPS_GRANULARITY_QUERY():
    return Query(
        "day",
        description="Finished OP series granularity: day or month.",
        pattern=_enum_pattern(PRODUCTION_APPOINTMENTS_FINISHED_OPS_GRANULARITY_VALUES),
        enum=list(PRODUCTION_APPOINTMENTS_FINISHED_OPS_GRANULARITY_VALUES),
    )
