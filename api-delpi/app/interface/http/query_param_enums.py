...
PRODUCTION_APPOINTMENTS_TEMPORAL_GRANULARITY_VALUES = ("day", "month")
PRODUCTION_APPOINTMENTS_FINISHED_OPS_GRANULARITY_VALUES = (
    PRODUCTION_APPOINTMENTS_TEMPORAL_GRANULARITY_VALUES
)
...
def PRODUCTION_APPOINTMENTS_TEMPORAL_GRANULARITY_QUERY():
    return Query(
        "day",
        description="Temporal series granularity: day or month.",
        pattern=_enum_pattern(PRODUCTION_APPOINTMENTS_TEMPORAL_GRANULARITY_VALUES),
        enum=list(PRODUCTION_APPOINTMENTS_TEMPORAL_GRANULARITY_VALUES),
    )


def PRODUCTION_APPOINTMENTS_FINISHED_OPS_GRANULARITY_QUERY():
