...
_OPERATION_FIELDS = {
    ...
    "pending_qty": {"label": "Saldo da OP", "type": "number"},
    "operation_produced_qty": {"label": "Produzido na operação", "type": "number"},
    "operation_pending_qty": {"label": "Saldo da operação", "type": "number"},
