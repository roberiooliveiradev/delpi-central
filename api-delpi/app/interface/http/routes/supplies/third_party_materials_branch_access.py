"""Autorização por filial — materiais de terceiros (Suprimentos)."""
...
_GATE = BranchAccessGate(
    global_view_perm=THIRD_PARTY_MATERIALS_ACCESS,
    branch_view_perms=dict(THIRD_PARTY_MATERIALS_BRANCH_VIEW_PERMS),
    resource_label="materiais de terceiros",
)
