"""Escopo — inspeções de entrada (reexporta escopo Protheus canônico)."""
...
VALID_INSPECOES_ENTRADA_BRANCHES = frozenset(PROTHEUS_BRANCH_CODES)
...
__all__ = [
    "BRANCH_SCOPE_TODAS",
    "BRANCH_SCOPE_VALUES",
    "VALID_INSPECOES_ENTRADA_BRANCHES",
    "is_all_branches",
    "normalize_branch_code",
    "normalize_branch_scope",
