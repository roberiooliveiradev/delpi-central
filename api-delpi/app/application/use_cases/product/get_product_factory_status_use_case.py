...
class GetProductFactoryStatusUseCase:
    ...
    def execute(self, request: ProductPlaybookRequest) -> dict:
        ...
        shipping_items = self._produced_quantity.list_detail(
        ...
        result = attach_pa_reference(
            {
                ...
                "indicators": {
                    ...
                    "total_exclusive_raw_materials": structure_summary[
                        "total_exclusive_raw_materials"
                    ],
                    "total_raw_materials_without_stock_for_one_pa": stock_summary[
                        "total_without_stock_for_one_pa"
                    ],
                    "max_pa_producible_from_stock": stock_summary.get(
                        "max_pa_producible_from_stock"
                    ),
                    "limiting_raw_material_code": stock_summary.get(
                        "limiting_raw_material_code"
                    ),
                    "total_pa_orders": production_summary["total_pa_orders"],
                    "total_pi_orders": production_summary["total_pi_orders"],
                    "total_pa_reported_quantity": production_summary[
                        "total_pa_reported_quantity"
                    ],
                    "total_pi_reported_quantity": production_summary[
                        "total_pi_reported_quantity"
                    ],
                    "total_pa_shipped_quantity": shipping_summary[
