# app/application/use_cases/internal_nc/upload_internal_nc_action_attachment_use_case.py
...
class UploadInternalNcActionAttachmentUseCase:
    def __init__(
        self,
    ...
    def execute(
        self,
        request: UploadInternalNcActionAttachmentRequest,
    ) -> NonconformityAttachment:
