# app/application/use_cases/internal_nc/add_internal_nc_root_cause_use_case.py
...
class AddInternalNcRootCauseUseCase:
    def __init__(
        self,
    ...
    def execute(
        self,
        request: AddInternalNcRootCauseRequest,
    ) -> InternalNonconformityRootCause:
        ...
        entity = InternalNonconformityRootCause(
            ...
            analysis_method=self._normalize(request.analysis_method),
            cause_dimension=self._normalize(request.cause_dimension),
            category=self._normalize(request.category),
    ...
    def _validate_request(self, request: AddInternalNcRootCauseRequest) -> None:
