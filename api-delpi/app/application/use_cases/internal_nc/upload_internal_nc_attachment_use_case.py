# app/application/use_cases/internal_nc/upload_internal_nc_attachment_use_case.py
...
class UploadInternalNcAttachmentUseCase:
    def __init__(
        self,
    ...
    def execute(
        self,
        request: UploadInternalNcAttachmentRequest,
    ) -> NonconformityAttachment:
    ...
    def _validate_request(self, request: UploadInternalNcAttachmentRequest) -> None:
