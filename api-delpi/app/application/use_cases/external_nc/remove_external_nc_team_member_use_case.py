# app/application/use_cases/external_nc/remove_external_nc_team_member_use_case.py
...
class RemoveExternalNcTeamMemberUseCase:
    def __init__(
        self,
    ...
    def execute(self, request: RemoveExternalNcTeamMemberRequest) -> None:
