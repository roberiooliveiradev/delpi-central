# app/application/use_cases/external_nc/update_external_nc_action_use_case.py
...
class UpdateExternalNcActionUseCase:
    def __init__(
        self,
    ...
    def execute(self, request: UpdateExternalNcActionRequest):
    ...
    def _validate_request(self, request: UpdateExternalNcActionRequest) -> None:
