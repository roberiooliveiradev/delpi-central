...
from app.application.dto.inspecoes_processo.inspecoes_processo_por_ensaiador_response import (
    InspecoesProcessoPorEnsaiadorItemResponse,
)
...
def _normalize_item(
    ...
    return InspecoesProcessoPorEnsaiadorItemResponse(
        ...
        login_ensaiador=_optional_str(row.get("Login_Ensaiador")),
...
class ListInspecoesProcessoPorEnsaiadorUseCase:
