...
from app.application.dto.inspecoes_processo.inspecoes_processo_por_operacao_response import (
    InspecoesProcessoPorOperacaoItemResponse,
)
...
def _normalize_item(
    ...
    return InspecoesProcessoPorOperacaoItemResponse(
...
class ListInspecoesProcessoPorOperacaoUseCase:
    ...
    def execute(
        ...
        *,
    ...
    ) -> list[InspecoesProcessoPorOperacaoItemResponse]:
        ...
        rows = self._repository.list_por_operacao_by_branch(
            normalized_branch,
