...
from app.application.dto.inspecoes_processo.inspecoes_processo_ranking_ensaio_response import (
    InspecoesProcessoRankingEnsaioItemResponse,
)
...
def _normalize_item(
    ...
    return InspecoesProcessoRankingEnsaioItemResponse(
...
class ListInspecoesProcessoRankingEnsaioUseCase:
