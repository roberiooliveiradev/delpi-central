...
from app.domain.ports.production.depreciation_repository_port import (
    DepreciationRepositoryPort,
)
from app.domain.ports.production.direct_labor_repository_port import (
...
from app.domain.ports.production.production_cost_repository_port import (
