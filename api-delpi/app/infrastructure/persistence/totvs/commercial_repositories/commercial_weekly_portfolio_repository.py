...
class CommercialWeeklyPortfolioRepository(
    ...
    def list_delivery_week_forecast_by_customer(
        ...
        *,
        ...
        where_clause, where_params, qty_expr = self._build_forecast_where(
    ...
    def sum_delivery_forecast(
        ...
        *,
        ...
        if not rows:
            return 0.0
        return round(float(rows[0].get("forecast_value") or 0), 2)
    ...
    def _build_forecast_where(
        *,
        ...
        return where_clause, where_params, qty_expr
