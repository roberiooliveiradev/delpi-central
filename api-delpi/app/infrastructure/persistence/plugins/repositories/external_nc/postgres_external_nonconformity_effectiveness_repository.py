# app/infrastructure/persistence/plugins/repositories/external_nc/postgres_external_nonconformity_effectiveness_repository.py
...
class PostgresExternalNonconformityEffectivenessRepository(
    PluginBaseRepository,
    ExternalNonconformityEffectivenessRepositoryPort,
):
    def create(
        ...
        row = self.execute_returning_one(
            """
            INSERT INTO quality.external_nc_effectiveness_checks (
                id,
                nonconformity_id,
                action_id,
                checked_by_user_id,
    ...
    def _to_entity(
        ...
        return ExternalNonconformityEffectivenessCheck(
            id=str(row["id"]),
