...
def test_month_closed_open_is_full_calendar_month_of_data_fim() -> None:
    ...
    mid = RefugosPeriod(start_date=date(2026, 7, 13), end_date=date(2026, 7, 14), branch="01")
    end = RefugosPeriod(start_date=date(2026, 7, 13), end_date=date(2026, 7, 15), branch="01")
...
def test_day_closed_open_follows_data_fim() -> None:
    period = RefugosPeriod(start_date=date(2026, 7, 13), end_date=date(2026, 7, 14), branch="01")
