"""Testes de autorização por filial — Acompanhamento de Refugos."""
...
from app.interface.http.routes.refugos.refugos_branch_access import (
    branch_access_error,
    branch_view_allowed,
)
...
def test_branch_view_allowed_with_filial_sc_only() -> None:
    user = SimpleNamespace(
        is_superadmin=False, permissions=[SCRAP_MONITORING_VIEW_FILIAL_SC]
    )
