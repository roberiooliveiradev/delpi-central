"""Escopo de carteira — só manage canônico eleva unrestricted."""
...
def test_unrestricted_only_seller_portfolios_manage() -> None:
...
def test_team_view_can_filter_without_unrestricted() -> None:
