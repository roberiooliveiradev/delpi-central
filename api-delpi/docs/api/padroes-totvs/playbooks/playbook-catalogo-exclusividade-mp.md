...
3. **Contrato estável:** [`fase-0-inventario-contrato-respostas.md`](../../../roadmaps/fase-0-inventario-contrato-respostas.md) define `get_product_structure` como `hierarchy` sem campos de playbook.
