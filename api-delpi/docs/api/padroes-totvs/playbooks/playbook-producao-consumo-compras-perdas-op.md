...
| `PurchaseValidityFilterService` | Exclui transportadoras (`%TRANSP%`), fornecedores internos e NF de frete (`D1_QUANT = 0` na MP) — ver [compras-validas-frete-mp-changelog-jun2026.md](../../compras-validas-frete-mp-changelog-jun2026.md) |
...
1. ✅ [`13-producao-operacional.md`](../../13-producao-operacional.md)
2. ✅ [`10-referencia-rapida-endpoints.md`](../../10-referencia-rapida-endpoints.md) — rotas operacionais + `/purchases`
3. ✅ [`11-guia-agente-chat.md`](../../11-guia-agente-chat.md) — seção Playbook 15
4. ✅ [`fase-0-inventario-contrato-respostas.md`](../../../roadmaps/fase-0-inventario-contrato-respostas.md) — matriz operationId operacional
