...
Filtros de compra válida: `PurchaseValidityFilterService` (exclui transportadoras por nome `%TRANSP%`, fornecedores internos `000019`, `001149`, e **notas de frete** com `D1_QUANT = 0` alocadas no código da MP). Detalhes: [compras-validas-frete-mp-changelog-jun2026.md](../../compras-validas-frete-mp-changelog-jun2026.md).
