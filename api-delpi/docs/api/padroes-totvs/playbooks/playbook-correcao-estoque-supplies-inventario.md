...
**Referências:** [supplies-estoque-historico.md](../../supplies-estoque-historico.md), regra `sql-query-development.mdc`, checklist `new-api-route-checklist.mdc` (se nova rota de diagnóstico)
...
Investigação MATR460 (jun/2026): [estoque-supplies-matr460-resumo-jun2026.md](../../../roadmaps/estoque-supplies-matr460-resumo-jun2026.md) · `scripts/investigate_matr460_inventory.py`
...
- Doc canônica: [estoque-supplies-modo-hibrido.md](../../../roadmaps/estoque-supplies-modo-hibrido.md)
...
- [x] [supplies-estoque-historico.md](../../supplies-estoque-historico.md) — modos `auto`/`hybrid`/`register_snapshot`/`estimated`/`official_closure`
- [x] [06-modulos-departamentais.md](../../06-modulos-departamentais.md) § Suprimentos
- [x] Changelog: `api-delpi/docs/changelog/2026-06-estoque-supplies-reconciliacao.md` (§ W5)
- [x] Doc canônica: [estoque-supplies-modo-hibrido.md](../../../roadmaps/estoque-supplies-modo-hibrido.md)
